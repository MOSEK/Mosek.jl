...
function getlasterror(task::MSKtask)
  ...
  __tmp_669 = Ref{Int64}()
  @MSK_getlasterror64(task.task,Ref{Int32}(),0,__tmp_669,C_NULL)
  __tmp_668 = __tmp_669[]
  sizelastmsg = Int64((__tmp_668 + Int64(1)))
...
function computesparsecholesky(env::MSKenv,numthreads::Int32,ordermethod::Int32,tolsingular::Float64,anzc::Vector{Int32},aptrc::Vector{Int64},asubc::Vector{Int32},avalc::Vector{Float64})
  ...
  __tmp_721 = n
  perm = copy(unsafe_wrap(Array,perm_[],__tmp_721))
  @MSK_freeenv(env.env,perm_[])
  perm .+= 1
  __tmp_722 = n
  diag = copy(unsafe_wrap(Array,diag_[],__tmp_722))
  @MSK_freeenv(env.env,diag_[])
  __tmp_723 = n
  lnzc = copy(unsafe_wrap(Array,lnzc_[],__tmp_723))
  @MSK_freeenv(env.env,lnzc_[])
  __tmp_724 = n
  lptrc = copy(unsafe_wrap(Array,lptrc_[],__tmp_724))
  @MSK_freeenv(env.env,lptrc_[])
  lptrc .+= 1
  __tmp_725 = lensubnval_[]
  lsubc = copy(unsafe_wrap(Array,lsubc_[],__tmp_725))
  @MSK_freeenv(env.env,lsubc_[])
  lsubc .+= 1
  __tmp_726 = lensubnval_[]
  lvalc = copy(unsafe_wrap(Array,lvalc_[],__tmp_726))
...
function computesparsecholesky(numthreads::Int32,ordermethod::Int32,tolsingular::Float64,anzc::Vector{Int32},aptrc::Vector{Int64},asubc::Vector{Int32},avalc::Vector{Float64})
  ...
  __tmp_728 = n
  perm = copy(unsafe_wrap(Array,perm_[],__tmp_728))
  @MSK_freeenv(Ptr{Nothing}(),perm_[])
  perm .+= 1
  __tmp_729 = n
  diag = copy(unsafe_wrap(Array,diag_[],__tmp_729))
  @MSK_freeenv(Ptr{Nothing}(),diag_[])
  __tmp_730 = n
  lnzc = copy(unsafe_wrap(Array,lnzc_[],__tmp_730))
  @MSK_freeenv(Ptr{Nothing}(),lnzc_[])
  __tmp_731 = n
  lptrc = copy(unsafe_wrap(Array,lptrc_[],__tmp_731))
  @MSK_freeenv(Ptr{Nothing}(),lptrc_[])
  lptrc .+= 1
  __tmp_732 = lensubnval_[]
  lsubc = copy(unsafe_wrap(Array,lsubc_[],__tmp_732))
  @MSK_freeenv(Ptr{Nothing}(),lsubc_[])
  lsubc .+= 1
  __tmp_733 = lensubnval_[]
  lvalc = copy(unsafe_wrap(Array,lvalc_[],__tmp_733))
