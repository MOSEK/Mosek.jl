...
"""
    analyzenames(task_:: MSKtask,whichstream_:: Int32,nametype_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichstream :: Int32`. Index of the stream.
* `nametype :: Int32`. The type of names e.g. valid in MPS or LP files.
...
function analyzenames(task_:: MSKtask,whichstream_:: Int32,nametype_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "analyzenames",Int32,(Ptr{Void},Int32,Int32,),task_.task,whichstream_,nametype_)
  end
  if res != MSK_RES_OK
...
"""
    analyzeproblem(task_:: MSKtask,whichstream_:: Int32)
...
function analyzeproblem(task_:: MSKtask,whichstream_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "analyzeproblem",Int32,(Ptr{Void},Int32,),task_.task,whichstream_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    analyzesolution(task_:: MSKtask,whichstream_:: Int32,whichsol_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichstream :: Int32`. Index of the stream.
* `whichsol :: Int32`. Selects a solution.
...
function analyzesolution(task_:: MSKtask,whichstream_:: Int32,whichsol_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "analyzesolution",Int32,(Ptr{Void},Int32,Int32,),task_.task,whichstream_,whichsol_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    appendbarvars{T1}(task:: MSKtask,dim:: Array{T1})
    appendbarvars(task_:: MSKtask,dim_:: Array{Int32})
...
appendbarvars{T1}(task:: MSKtask,dim:: Array{T1}) = appendbarvars(task,convert(Array{Int32},dim))
function appendbarvars(task_:: MSKtask,dim_:: Array{Int32})
  num_ = minimum([ length(dim_) ])
  res = disable_sigint() do
    @msk_ccall( "appendbarvars",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,num_,dim_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    appendcone{T2,T3}(task:: MSKtask,ct:: Int32,conepar:: T2,submem:: Array{T3})
    appendcone(task_:: MSKtask,ct_:: Int32,conepar_:: Float64,submem_:: Array{Int32})
...
appendcone{T2,T3}(task:: MSKtask,ct:: Int32,conepar:: T2,submem:: Array{T3}) = appendcone(task,ct,Float64(conepar),convert(Array{Int32},submem))
function appendcone(task_:: MSKtask,ct_:: Int32,conepar_:: Float64,submem_:: Array{Int32})
  nummem_ = minimum([ length(submem_) ])
  res = disable_sigint() do
    @msk_ccall( "appendcone",Int32,(Ptr{Void},Int32,Float64,Int32,Ptr{Int32},),task_.task,ct_,conepar_,nummem_,submem_ .- Int32(1))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    appendconeseq{T2,T3,T4}(task:: MSKtask,ct:: Int32,conepar:: T2,nummem:: T3,j:: T4)
    appendconeseq(task_:: MSKtask,ct_:: Int32,conepar_:: Float64,nummem_:: Int32,j_:: Int32)
...
appendconeseq{T2,T3,T4}(task:: MSKtask,ct:: Int32,conepar:: T2,nummem:: T3,j:: T4) = appendconeseq(task,ct,Float64(conepar),Int32(nummem),Int32(j))
function appendconeseq(task_:: MSKtask,ct_:: Int32,conepar_:: Float64,nummem_:: Int32,j_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "appendconeseq",Int32,(Ptr{Void},Int32,Float64,Int32,Int32,),task_.task,ct_,conepar_,nummem_,j_-1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    appendconesseq{T2,T3,T4}(task:: MSKtask,ct:: Array{Int32},conepar:: Array{T2},nummem:: Array{T3},j:: T4)
    appendconesseq(task_:: MSKtask,ct_:: Array{Int32},conepar_:: Array{Float64},nummem_:: Array{Int32},j_:: Int32)

* `task :: MSKtask`. An optimization task.
* `ct :: Array{Int32}`. Specifies the type of the cone.
* `conepar :: Array{Float64}`. This argument is currently not used. It can be set to 0
...
appendconesseq{T2,T3,T4}(task:: MSKtask,ct:: Array{Int32},conepar:: Array{T2},nummem:: Array{T3},j:: T4) = appendconesseq(task,ct,convert(Array{Float64},conepar),convert(Array{Int32},nummem),Int32(j))
function appendconesseq(task_:: MSKtask,ct_:: Array{Int32},conepar_:: Array{Float64},nummem_:: Array{Int32},j_:: Int32)
  num_ = minimum([ length(ct_),length(conepar_),length(nummem_) ])
  res = disable_sigint() do
    @msk_ccall( "appendconesseq",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},Ptr{Int32},Int32,),task_.task,num_,ct_,conepar_,nummem_,j_-1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function appendcons(task_:: MSKtask,num_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "appendcons",Int32,(Ptr{Void},Int32,),task_.task,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    appendsparsesymmat{T1,T2,T3,T4}(task:: MSKtask,dim:: T1,subi:: Array{T2},subj:: Array{T3},valij:: Array{T4})
    appendsparsesymmat(task_:: MSKtask,dim_:: Int32,subi_:: Array{Int32},subj_:: Array{Int32},valij_:: Array{Float64})
...
appendsparsesymmat{T1,T2,T3,T4}(task:: MSKtask,dim:: T1,subi:: Array{T2},subj:: Array{T3},valij:: Array{T4}) = appendsparsesymmat(task,Int32(dim),convert(Array{Int32},subi),convert(Array{Int32},subj),convert(Array{Float64},valij))
function appendsparsesymmat(task_:: MSKtask,dim_:: Int32,subi_:: Array{Int32},subj_:: Array{Int32},valij_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "appendsparsesymmat",Int32,(Ptr{Void},Int32,Int64,Ptr{Int32},Ptr{Int32},Ptr{Float64},Ptr{Int64},),task_.task,dim_,nz_,subi_ .- Int32(1),subj_ .- Int32(1),valij_,idx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function appendvars(task_:: MSKtask,num_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "appendvars",Int32,(Ptr{Void},Int32,),task_.task,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function basiscond(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "basiscond",Int32,(Ptr{Void},Ptr{Float64},Ptr{Float64},),task_.task,nrmbasis_,nrminvbasis_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    bktostr(task_:: MSKtask,bk_:: Int32)
...
"""
    callbackcodetostr(code_:: Int32)

* `code :: Int32`. A callback code.
...
function checkconvexity(task_:: MSKtask)
  res = disable_sigint() do
    @msk_ccall( "checkconvexity",Int32,(Ptr{Void},),task_.task)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
checkmem{T2}(task:: MSKtask,file:: AbstractString,line:: T2) = checkmem(task,file,Int32(line))
function checkmem(task_:: MSKtask,file_:: AbstractString,line_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "checkmemtask",Int32,(Ptr{Void},Ptr{UInt8},Int32,),task_.task,string(file_),line_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    chgbound{T2,T3,T4,T5}(task:: MSKtask,accmode:: Int32,i:: T2,lower:: T3,finite:: T4,value:: T5)
    chgbound(task_:: MSKtask,accmode_:: Int32,i_:: Int32,lower_:: Int32,finite_:: Int32,value_:: Float64)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines if operations are performed row-wise (constraint-oriented) or column-wise (variable-oriented).
...
function chgbound(task_:: MSKtask,accmode_:: Int32,i_:: Int32,lower_:: Int32,finite_:: Int32,value_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "chgbound",Int32,(Ptr{Void},Int32,Int32,Int32,Int32,Float64,),task_.task,accmode_,i_-1,lower_,finite_,value_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
chgconbound{T1,T2,T3,T4}(task:: MSKtask,i:: T1,lower:: T2,finite:: T3,value:: T4) = chgconbound(task,Int32(i),Int32(lower),Int32(finite),Float64(value))
function chgconbound(task_:: MSKtask,i_:: Int32,lower_:: Int32,finite_:: Int32,value_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "chgconbound",Int32,(Ptr{Void},Int32,Int32,Int32,Float64,),task_.task,i_-1,lower_,finite_,value_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
chgvarbound{T1,T2,T3,T4}(task:: MSKtask,j:: T1,lower:: T2,finite:: T3,value:: T4) = chgvarbound(task,Int32(j),Int32(lower),Int32(finite),Float64(value))
function chgvarbound(task_:: MSKtask,j_:: Int32,lower_:: Int32,finite_:: Int32,value_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "chgvarbound",Int32,(Ptr{Void},Int32,Int32,Int32,Float64,),task_.task,j_-1,lower_,finite_,value_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function commitchanges(task_:: MSKtask)
  res = disable_sigint() do
    @msk_ccall( "commitchanges",Int32,(Ptr{Void},),task_.task)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    conetypetostr(task_:: MSKtask,ct_:: Int32)
...
"""
    deletesolution(task_:: MSKtask,whichsol_:: Int32)
...
function deletesolution(task_:: MSKtask,whichsol_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "deletesolution",Int32,(Ptr{Void},Int32,),task_.task,whichsol_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    dualsensitivity{T1}(task:: MSKtask,subj:: Array{T1})
    dualsensitivity(task_:: MSKtask,subj_:: Array{Int32})
...
function dualsensitivity(task_:: MSKtask,subj_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "dualsensitivity",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,numj_,subj_ .- Int32(1),__tmp_var_1,__tmp_var_3,__tmp_var_5,__tmp_var_7)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getacol(task_:: MSKtask,j_:: Int32)
  ...
  valj_ = __tmp_var_3
  res = disable_sigint() do
    @msk_ccall( "getacol",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,j_-1,nzj_,__tmp_var_1,__tmp_var_3)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
...
function getacolnumnz(task_:: MSKtask,i_:: Int32)
  nzj_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getacolnumnz",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,i_-1,nzj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getaij(task_:: MSKtask,i_:: Int32,j_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getaij",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,i_-1,j_-1,aij_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getapiecenumnz(task_:: MSKtask,firsti_:: Int32,lasti_:: Int32,firstj_:: Int32,lastj_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getapiecenumnz",Int32,(Ptr{Void},Int32,Int32,Int32,Int32,Ptr{Int32},),task_.task,firsti_-1,lasti_-1,firstj_-1,lastj_-1,numnz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getarow(task_:: MSKtask,i_:: Int32)
  ...
  vali_ = __tmp_var_3
  res = disable_sigint() do
    @msk_ccall( "getarow",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,i_-1,nzi_,__tmp_var_1,__tmp_var_3)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
...
function getarownumnz(task_:: MSKtask,i_:: Int32)
  nzi_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getarownumnz",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,i_-1,nzi_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getarowslicetrip(task_:: MSKtask,first_:: Int32,last_:: Int32)
  ...
  surp_ = convert(Int64,length(subi_))
  res = disable_sigint() do
    @msk_ccall( "getarowslicetrip",Int32,(Ptr{Void},Int32,Int32,Int64,Ptr{Int64},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,first_-1,last_-1,maxnumnz_,&surp_,__tmp_var_1,__tmp_var_3,__tmp_var_5)
  end
  __tmp_var_1 += 1
  __tmp_var_3 += 1
  if res != MSK_RES_OK
...
"""
    getaslice{T2,T3}(task:: MSKtask,accmode:: Int32,first:: T2,last:: T3)
    getaslice(task_:: MSKtask,accmode_:: Int32,first_:: Int32,last_:: Int32)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines whether a column slice or a row slice is requested.
...
function getaslice(task_:: MSKtask,accmode_:: Int32,first_:: Int32,last_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getaslice64",Int32,(Ptr{Void},Int32,Int32,Int32,Int64,Ptr{Int64},Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Float64},),task_.task,accmode_,first_-1,last_-1,maxnumnz_,&surp_,__tmp_var_1,__tmp_var_3,__tmp_var_5,__tmp_var_7)
  end
  __tmp_var_1 += 1
  __tmp_var_3 += 1
  __tmp_var_5 += 1
...
"""
    getaslicenumnz{T2,T3}(task:: MSKtask,accmode:: Int32,first:: T2,last:: T3)
    getaslicenumnz(task_:: MSKtask,accmode_:: Int32,first_:: Int32,last_:: Int32)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines whether non-zeros are counted in a column slice or a row slice.
* `first :: Int32`. Index of the first row or column in the sequence.
...
function getaslicenumnz(task_:: MSKtask,accmode_:: Int32,first_:: Int32,last_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getaslicenumnz64",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int64},),task_.task,accmode_,first_-1,last_-1,numnz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbarablocktriplet(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getbarablocktriplet",Int32,(Ptr{Void},Int64,Ptr{Int64},Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,maxnum_,num_,__tmp_var_1,__tmp_var_3,__tmp_var_5,__tmp_var_7,__tmp_var_9)
  end
  __tmp_var_1 += 1
  __tmp_var_3 += 1
  __tmp_var_5 += 1
...
function getbaraidx(task_:: MSKtask,idx_:: Int64)
  ...
  res = disable_sigint() do
    @msk_ccall( "getbaraidx",Int32,(Ptr{Void},Int64,Int64,Ptr{Int32},Ptr{Int32},Ptr{Int64},Ptr{Int64},Ptr{Float64},),task_.task,idx_-1,maxnum_,i_,j_,num_,__tmp_var_1,__tmp_var_3)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
...
function getbaraidxij(task_:: MSKtask,idx_:: Int64)
  ...
  j_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getbaraidxij",Int32,(Ptr{Void},Int64,Ptr{Int32},Ptr{Int32},),task_.task,idx_-1,i_,j_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbaraidxinfo(task_:: MSKtask,idx_:: Int64)
  num_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getbaraidxinfo",Int32,(Ptr{Void},Int64,Ptr{Int64},),task_.task,idx_-1,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbarasparsity(task_:: MSKtask)
  ...
  idxij_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getbarasparsity",Int32,(Ptr{Void},Int64,Ptr{Int64},Ptr{Int64},),task_.task,maxnumnz_,numnz_,__tmp_var_1)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
...
function getbarcidx(task_:: MSKtask,idx_:: Int64)
  ...
  weights_ = __tmp_var_3
  res = disable_sigint() do
    @msk_ccall( "getbarcidx",Int32,(Ptr{Void},Int64,Int64,Ptr{Int32},Ptr{Int64},Ptr{Int64},Ptr{Float64},),task_.task,idx_-1,maxnum_,j_,num_,__tmp_var_1,__tmp_var_3)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
...
function getbarcidxinfo(task_:: MSKtask,idx_:: Int64)
  num_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getbarcidxinfo",Int32,(Ptr{Void},Int64,Ptr{Int64},),task_.task,idx_-1,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbarcidxj(task_:: MSKtask,idx_:: Int64)
  j_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getbarcidxj",Int32,(Ptr{Void},Int64,Ptr{Int32},),task_.task,idx_-1,j_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbarcsparsity(task_:: MSKtask)
  ...
  idxj_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getbarcsparsity",Int32,(Ptr{Void},Int64,Ptr{Int64},Ptr{Int64},),task_.task,maxnumnz_,numnz_,__tmp_var_1)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
...
"""
    getbarsj{T2}(task:: MSKtask,whichsol:: Int32,j:: T2)
    getbarsj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32)
...
function getbarsj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32)
  ...
  barsj_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getbarsj",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,whichsol_,j_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbarvarnameindex(task_:: MSKtask,somename_:: AbstractString)
  ...
  res = disable_sigint() do
    @msk_ccall( "getbarvarnameindex",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},Ptr{Int32},),task_.task,string(somename_),asgn_,index_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getbarvarnamelen(task_:: MSKtask,i_:: Int32)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getbarvarnamelen",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,i_-1,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getbarxj{T2}(task:: MSKtask,whichsol:: Int32,j:: T2)
    getbarxj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32)
...
function getbarxj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32)
  ...
  barxj_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getbarxj",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,whichsol_,j_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getbound{T2}(task:: MSKtask,accmode:: Int32,i:: T2)
    getbound(task_:: MSKtask,accmode_:: Int32,i_:: Int32)
...
function getbound(task_:: MSKtask,accmode_:: Int32,i_:: Int32)
  ...
  bu_ = Array{Float64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getbound",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,accmode_,i_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getboundslice{T2,T3}(task:: MSKtask,accmode:: Int32,first:: T2,last:: T3)
    getboundslice(task_:: MSKtask,accmode_:: Int32,first_:: Int32,last_:: Int32)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines if operations are performed row-wise (constraint-oriented) or column-wise (variable-oriented).
* `first :: Int32`. First index in the sequence.
* `last :: Int32`. Last index plus 1 in the sequence.
* `bk :: Array{Int32}`. Bound keys.
...
function getboundslice(task_:: MSKtask,accmode_:: Int32,first_:: Int32,last_:: Int32)
  ...
  bu_ = __tmp_var_4
  res = disable_sigint() do
    @msk_ccall( "getboundslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,accmode_,first_-1,last_-1,bk_,__tmp_var_2,__tmp_var_4)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getc(task_:: MSKtask)
  ...
  c_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getc",Int32,(Ptr{Void},Ptr{Float64},),task_.task,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getcfix(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getcfix",Int32,(Ptr{Void},Ptr{Float64},),task_.task,cfix_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getcj(task_:: MSKtask,j_:: Int32)
  cj_ = Array{Float64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getcj",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,j_-1,cj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getconbound(task_:: MSKtask,i_:: Int32)
  ...
  bu_ = Array{Float64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getconbound",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,i_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getconboundslice(task_:: MSKtask,first_:: Int32,last_:: Int32)
  ...
  bu_ = __tmp_var_4
  res = disable_sigint() do
    @msk_ccall( "getconboundslice",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,first_-1,last_-1,bk_,__tmp_var_2,__tmp_var_4)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getcone(task_:: MSKtask,k_:: Int32)
  ...
  submem_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getcone",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},Ptr{Int32},Ptr{Int32},),task_.task,k_-1,ct_,conepar_,nummem_,__tmp_var_1)
  end
  __tmp_var_1 += 1
  if res != MSK_RES_OK
    msg = getlasterror(task_)
  ...
  (convert(Int32,ct_[1]),convert(Float64,conepar_[1]),convert(Int32,nummem_[1]),__tmp_var_1)
end
...
function getconeinfo(task_:: MSKtask,k_:: Int32)
  ...
  nummem_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getconeinfo",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},Ptr{Int32},),task_.task,k_-1,ct_,conepar_,nummem_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
  end
  (convert(Int32,ct_[1]),convert(Float64,conepar_[1]),convert(Int32,nummem_[1]))
end
...
function getconenameindex(task_:: MSKtask,somename_:: AbstractString)
  ...
  index_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getconenameindex",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},Ptr{Int32},),task_.task,string(somename_),asgn_,index_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getconenamelen(task_:: MSKtask,i_:: Int32)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getconenamelen",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,i_-1,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getconnameindex(task_:: MSKtask,somename_:: AbstractString)
  ...
  index_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getconnameindex",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},Ptr{Int32},),task_.task,string(somename_),asgn_,index_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getconnamelen(task_:: MSKtask,i_:: Int32)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getconnamelen",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,i_-1,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getcslice(task_:: MSKtask,first_:: Int32,last_:: Int32)
  ...
  c_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getcslice",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getdimbarvarj(task_:: MSKtask,j_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getdimbarvarj",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,j_-1,dimbarvarj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdouinf(task_:: MSKtask,whichdinf_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichdinf :: Int32`. Specifies a double information item.
...
function getdouinf(task_:: MSKtask,whichdinf_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getdouinf",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichdinf_,dvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdouparam(task_:: MSKtask,param_:: Int32)
...
function getdouparam(task_:: MSKtask,param_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getdouparam",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,param_,parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdualobj(task_:: MSKtask,whichsol_:: Int32)
...
function getdualobj(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getdualobj",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,dualobj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdualsolutionnorms(task_:: MSKtask,whichsol_:: Int32)
...
function getdualsolutionnorms(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getdualsolutionnorms",Int32,(Ptr{Void},Int32,Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,whichsol_,nrmy_,nrmslc_,nrmsuc_,nrmslx_,nrmsux_,nrmsnx_,nrmbars_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdviolbarvar{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getdviolbarvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getdviolbarvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getdviolbarvar",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdviolcon{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getdviolcon(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getdviolcon(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getdviolcon",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdviolcones{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getdviolcones(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getdviolcones(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getdviolcones",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getdviolvar{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getdviolvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getdviolvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getdviolvar",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getinfeasiblesubproblem(task_:: MSKtask,whichsol_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichsol :: Int32`. Which solution to use when determining the infeasible subproblem.
...
function getinfeasiblesubproblem(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getinfeasiblesubproblem",Int32,(Ptr{Void},Int32,Ptr{Ptr{Void}},),task_.task,whichsol_,inftask_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getinfname{T2}(task:: MSKtask,inftype:: Int32,whichinf:: T2)
    getinfname(task_:: MSKtask,inftype_:: Int32,whichinf_:: Int32)

* `task :: MSKtask`. An optimization task.
* `inftype :: Int32`. Type of the information item.
...
"""
    getintinf(task_:: MSKtask,whichiinf_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichiinf :: Int32`. Specifies an integer information item.
...
function getintinf(task_:: MSKtask,whichiinf_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getintinf",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichiinf_,ivalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getintparam(task_:: MSKtask,param_:: Int32)
...
function getintparam(task_:: MSKtask,param_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getintparam",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,param_,parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getlenbarvarj(task_:: MSKtask,j_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getlenbarvarj",Int32,(Ptr{Void},Int32,Ptr{Int64},),task_.task,j_-1,lenbarvarj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getlintinf(task_:: MSKtask,whichliinf_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichliinf :: Int32`. Specifies a long information item.
...
function getlintinf(task_:: MSKtask,whichliinf_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getlintinf",Int32,(Ptr{Void},Int32,Ptr{Int64},),task_.task,whichliinf_,ivalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmaxnumanz(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmaxnumanz64",Int32,(Ptr{Void},Ptr{Int64},),task_.task,maxnumanz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmaxnumbarvar(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmaxnumbarvar",Int32,(Ptr{Void},Ptr{Int32},),task_.task,maxnumbarvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmaxnumcon(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmaxnumcon",Int32,(Ptr{Void},Ptr{Int32},),task_.task,maxnumcon_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmaxnumcone(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmaxnumcone",Int32,(Ptr{Void},Ptr{Int32},),task_.task,maxnumcone_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmaxnumqnz(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmaxnumqnz64",Int32,(Ptr{Void},Ptr{Int64},),task_.task,maxnumqnz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmaxnumvar(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmaxnumvar",Int32,(Ptr{Void},Ptr{Int32},),task_.task,maxnumvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getmemusage(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getmemusagetask",Int32,(Ptr{Void},Ptr{Int64},Ptr{Int64},),task_.task,meminuse_,maxmemuse_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnadouparam(task_:: MSKtask,paramname_:: AbstractString)
  parvalue_ = Array{Float64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnadouparam",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Float64},),task_.task,string(paramname_),parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnaintinf(task_:: MSKtask,infitemname_:: AbstractString)
  ivalue_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnaintinf",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(infitemname_),ivalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnaintparam(task_:: MSKtask,paramname_:: AbstractString)
  parvalue_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnaintparam",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(paramname_),parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumanz(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumanz",Int32,(Ptr{Void},Ptr{Int32},),task_.task,numanz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumanz64(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumanz64",Int32,(Ptr{Void},Ptr{Int64},),task_.task,numanz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumbarablocktriplets(task_:: MSKtask)
  num_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnumbarablocktriplets",Int32,(Ptr{Void},Ptr{Int64},),task_.task,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumbaranz(task_:: MSKtask)
  nz_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnumbaranz",Int32,(Ptr{Void},Ptr{Int64},),task_.task,nz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumbarcblocktriplets(task_:: MSKtask)
  num_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnumbarcblocktriplets",Int32,(Ptr{Void},Ptr{Int64},),task_.task,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumbarcnz(task_:: MSKtask)
  nz_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnumbarcnz",Int32,(Ptr{Void},Ptr{Int64},),task_.task,nz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumbarvar(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumbarvar",Int32,(Ptr{Void},Ptr{Int32},),task_.task,numbarvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumcon(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumcon",Int32,(Ptr{Void},Ptr{Int32},),task_.task,numcon_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumcone(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumcone",Int32,(Ptr{Void},Ptr{Int32},),task_.task,numcone_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumconemem(task_:: MSKtask,k_:: Int32)
  nummem_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnumconemem",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,k_-1,nummem_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumintvar(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumintvar",Int32,(Ptr{Void},Ptr{Int32},),task_.task,numintvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getnumparam(task_:: MSKtask,partype_:: Int32)

* `task :: MSKtask`. An optimization task.
* `partype :: Int32`. Parameter type.
...
function getnumparam(task_:: MSKtask,partype_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumparam",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,partype_,numparam_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumqconknz(task_:: MSKtask,k_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumqconknz64",Int32,(Ptr{Void},Int32,Ptr{Int64},),task_.task,k_-1,numqcnz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumqobjnz(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumqobjnz64",Int32,(Ptr{Void},Ptr{Int64},),task_.task,numqonz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumsymmat(task_:: MSKtask)
  num_ = Array{Int64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getnumsymmat",Int32,(Ptr{Void},Ptr{Int64},),task_.task,num_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getnumvar(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getnumvar",Int32,(Ptr{Void},Ptr{Int32},),task_.task,numvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getobjnamelen(task_:: MSKtask)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getobjnamelen",Int32,(Ptr{Void},Ptr{Int32},),task_.task,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getobjsense(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getobjsense",Int32,(Ptr{Void},Ptr{Int32},),task_.task,sense_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getparamname{T2}(task:: MSKtask,partype:: Int32,param:: T2)
    getparamname(task_:: MSKtask,partype_:: Int32,param_:: Int32)
...
"""
    getprimalobj(task_:: MSKtask,whichsol_:: Int32)
...
function getprimalobj(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getprimalobj",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,primalobj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getprimalsolutionnorms(task_:: MSKtask,whichsol_:: Int32)
...
function getprimalsolutionnorms(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getprimalsolutionnorms",Int32,(Ptr{Void},Int32,Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,whichsol_,nrmxc_,nrmxx_,nrmbarx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getprobtype(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getprobtype",Int32,(Ptr{Void},Ptr{Int32},),task_.task,probtype_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getprosta(task_:: MSKtask,whichsol_:: Int32)
...
function getprosta(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getprosta",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,prosta_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getpviolbarvar{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getpviolbarvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getpviolbarvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getpviolbarvar",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getpviolcon{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getpviolcon(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getpviolcon(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getpviolcon",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getpviolcones{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getpviolcones(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getpviolcones(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getpviolcones",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getpviolvar{T2}(task:: MSKtask,whichsol:: Int32,sub:: Array{T2})
    getpviolvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
...
function getpviolvar(task_:: MSKtask,whichsol_:: Int32,sub_:: Array{Int32})
  ...
  viol_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getpviolvar",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,whichsol_,num_,sub_ .- Int32(1),__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getqconk(task_:: MSKtask,k_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getqconk64",Int32,(Ptr{Void},Int32,Int64,Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,k_-1,maxnumqcnz_,&qcsurp_,numqcnz_,__tmp_var_1,__tmp_var_3,__tmp_var_5)
  end
  __tmp_var_1 += 1
  __tmp_var_3 += 1
  if res != MSK_RES_OK
...
function getqobj(task_:: MSKtask)
  ...
  res = disable_sigint() do
    @msk_ccall( "getqobj64",Int32,(Ptr{Void},Int64,Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,maxnumqonz_,&qosurp_,numqonz_,__tmp_var_1,__tmp_var_3,__tmp_var_5)
  end
  __tmp_var_1 += 1
  __tmp_var_3 += 1
  if res != MSK_RES_OK
...
function getqobjij(task_:: MSKtask,i_:: Int32,j_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getqobjij",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,i_-1,j_-1,qoij_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getreducedcosts{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getreducedcosts(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getreducedcosts(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getreducedcosts",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getskc(task_:: MSKtask,whichsol_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichsol :: Int32`. Selects a solution.
* `skc :: Array{Int32}`. Status keys for the constraints.
...
function getskc(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getskc",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,skc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getskcslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getskcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getskcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  skc_ = zeros(Int32,__tmp_var_0)
  res = disable_sigint() do
    @msk_ccall( "getskcslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},),task_.task,whichsol_,first_-1,last_-1,skc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getskx(task_:: MSKtask,whichsol_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichsol :: Int32`. Selects a solution.
* `skx :: Array{Int32}`. Status keys for the variables.
...
function getskx(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getskx",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,skx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getskxslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getskxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getskxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  skx_ = zeros(Int32,__tmp_var_0)
  res = disable_sigint() do
    @msk_ccall( "getskxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},),task_.task,whichsol_,first_-1,last_-1,skx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getslc(task_:: MSKtask,whichsol_:: Int32)
...
function getslc(task_:: MSKtask,whichsol_:: Int32)
  ...
  slc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getslc",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getslcslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getslcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getslcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  slc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getslcslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getslx(task_:: MSKtask,whichsol_:: Int32)
...
function getslx(task_:: MSKtask,whichsol_:: Int32)
  ...
  slx_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getslx",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getslxslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getslxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getslxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  slx_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getslxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsnx(task_:: MSKtask,whichsol_:: Int32)
...
function getsnx(task_:: MSKtask,whichsol_:: Int32)
  ...
  snx_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsnx",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsnxslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getsnxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getsnxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  snx_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsnxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsolsta(task_:: MSKtask,whichsol_:: Int32)
...
function getsolsta(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getsolsta",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,solsta_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsolution(task_:: MSKtask,whichsol_:: Int32)
...
* `skc :: Array{Int32}`. Status keys for the constraints.
* `skx :: Array{Int32}`. Status keys for the variables.
* `skn :: Array{Int32}`. Status keys for the conic constraints.
...
function getsolution(task_:: MSKtask,whichsol_:: Int32)
  ...
  y_ = __tmp_var_8
  res = disable_sigint() do
    @msk_ccall( "getsolution",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,whichsol_,prosta_,solsta_,skc_,skx_,skn_,__tmp_var_4,__tmp_var_6,__tmp_var_8,__tmp_var_10,__tmp_var_12,__tmp_var_14,__tmp_var_16,__tmp_var_18)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsolutioni{T2}(task:: MSKtask,accmode:: Int32,i:: T2,whichsol:: Int32)
    getsolutioni(task_:: MSKtask,accmode_:: Int32,i_:: Int32,whichsol_:: Int32)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines whether solution information for a constraint or for a variable is retrieved.
...
function getsolutioni(task_:: MSKtask,accmode_:: Int32,i_:: Int32,whichsol_:: Int32)
  ...
  x_ = Array{Float64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getsolutioni",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,accmode_,i_-1,whichsol_,sk_,x_,sl_,su_,sn_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsolutioninfo(task_:: MSKtask,whichsol_:: Int32)
...
"""
    getsolutionslice{T3,T4}(task:: MSKtask,whichsol:: Int32,solitem:: Int32,first:: T3,last:: T4)
    getsolutionslice(task_:: MSKtask,whichsol_:: Int32,solitem_:: Int32,first_:: Int32,last_:: Int32)

* `task :: MSKtask`. An optimization task.
* `whichsol :: Int32`. Selects a solution.
* `solitem :: Int32`. Which part of the solution is required.
* `first :: Int32`. First index in the sequence.
* `last :: Int32`. Last index plus 1 in the sequence.
...
function getsolutionslice(task_:: MSKtask,whichsol_:: Int32,solitem_:: Int32,first_:: Int32,last_:: Int32)
  ...
  values_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsolutionslice",Int32,(Ptr{Void},Int32,Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,solitem_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getsparsesymmat(task_:: MSKtask,idx_:: Int64)
  ...
  valij_ = __tmp_var_5
  res = disable_sigint() do
    @msk_ccall( "getsparsesymmat",Int32,(Ptr{Void},Int64,Int64,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,idx_-1,maxlen_,__tmp_var_1,__tmp_var_3,__tmp_var_5)
  end
  __tmp_var_1 += 1
  __tmp_var_3 += 1
  if res != MSK_RES_OK
...
"""
    getstrparam(task_:: MSKtask,param_:: Int32)
...
"""
    getstrparamlen(task_:: MSKtask,param_:: Int32)
...
function getstrparamlen(task_:: MSKtask,param_:: Int32)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getstrparamlen",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,param_,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsuc(task_:: MSKtask,whichsol_:: Int32)
...
function getsuc(task_:: MSKtask,whichsol_:: Int32)
  ...
  suc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsuc",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsucslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getsucslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getsucslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  suc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsucslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsux(task_:: MSKtask,whichsol_:: Int32)
...
function getsux(task_:: MSKtask,whichsol_:: Int32)
  ...
  sux_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsux",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getsuxslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getsuxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getsuxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  sux_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getsuxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getsymmatinfo(task_:: MSKtask,idx_:: Int64)
  ...
  type_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getsymmatinfo",Int32,(Ptr{Void},Int64,Ptr{Int32},Ptr{Int64},Ptr{Int32},),task_.task,idx_-1,dim_,nz_,type_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function gettasknamelen(task_:: MSKtask)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "gettasknamelen",Int32,(Ptr{Void},Ptr{Int32},),task_.task,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getvarbound(task_:: MSKtask,i_:: Int32)
  ...
  bu_ = Array{Float64}((1,))
  res = disable_sigint() do
    @msk_ccall( "getvarbound",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,i_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getvarboundslice(task_:: MSKtask,first_:: Int32,last_:: Int32)
  ...
  bu_ = __tmp_var_4
  res = disable_sigint() do
    @msk_ccall( "getvarboundslice",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,first_-1,last_-1,bk_,__tmp_var_2,__tmp_var_4)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getvarnameindex(task_:: MSKtask,somename_:: AbstractString)
  ...
  index_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getvarnameindex",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},Ptr{Int32},),task_.task,string(somename_),asgn_,index_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getvarnamelen(task_:: MSKtask,i_:: Int32)
  len_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "getvarnamelen",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,i_-1,len_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function getvartype(task_:: MSKtask,j_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "getvartype",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,j_-1,vartype_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getvartypelist{T1}(task:: MSKtask,subj:: Array{T1})
    getvartypelist(task_:: MSKtask,subj_:: Array{Int32})

* `task :: MSKtask`. An optimization task.
* `subj :: Array{Int32}`. A list of variable indexes.
* `vartype :: Array{Int32}`. Returns the variables types corresponding the variable indexes requested.
...
function getvartypelist(task_:: MSKtask,subj_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "getvartypelist",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},),task_.task,num_,subj_ .- Int32(1),vartype_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getxc(task_:: MSKtask,whichsol_:: Int32)
...
function getxc(task_:: MSKtask,whichsol_:: Int32)
  ...
  xc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getxc",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getxcslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getxcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getxcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  xc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getxcslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getxx(task_:: MSKtask,whichsol_:: Int32)
...
function getxx(task_:: MSKtask,whichsol_:: Int32)
  ...
  xx_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getxx",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getxxslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getxxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getxxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  xx_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getxxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    gety(task_:: MSKtask,whichsol_:: Int32)
...
function gety(task_:: MSKtask,whichsol_:: Int32)
  ...
  y_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "gety",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    getyslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3)
    getyslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
...
function getyslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32)
  ...
  y_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "getyslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function initbasissolve(task_:: MSKtask)
  ...
  basis_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "initbasissolve",Int32,(Ptr{Void},Ptr{Int32},),task_.task,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    inputdata{T1,T2,T3,T4,T5,T6,T7,T8,T10,T11,T13,T14}(task:: MSKtask,maxnumcon:: T1,maxnumvar:: T2,c:: Array{T3},cfix:: T4,aptrb:: Array{T5},aptre:: Array{T6},asub:: Array{T7},aval:: Array{T8},bkc:: Array{Int32},blc:: Array{T10},buc:: Array{T11},bkx:: Array{Int32},blx:: Array{T13},bux:: Array{T14})
    inputdata{T1,T2,T3,T4,T10,T11,T13,T14}(task:: MSKtask,maxnumcon:: T1,maxnumvar:: T2,c:: Array{T3},cfix:: T4,A:: SparseMatrixCSC{Float64},bkc:: Array{Int32},blc:: Array{T10},buc:: Array{T11},bkx:: Array{Int32},blx:: Array{T13},bux:: Array{T14})
    inputdata(task_:: MSKtask,maxnumcon_:: Int32,maxnumvar_:: Int32,c_:: Array{Float64},cfix_:: Float64,aptrb_:: Array{Int64},aptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64},bkc_:: Array{Int32},blc_:: Array{Float64},buc_:: Array{Float64},bkx_:: Array{Int32},blx_:: Array{Float64},bux_:: Array{Float64})
...
inputdata{T1,T2,T3,T4,T5,T6,T7,T8,T10,T11,T13,T14}(task:: MSKtask,maxnumcon:: T1,maxnumvar:: T2,c:: Array{T3},cfix:: T4,aptrb:: Array{T5},aptre:: Array{T6},asub:: Array{T7},aval:: Array{T8},bkc:: Array{Int32},blc:: Array{T10},buc:: Array{T11},bkx:: Array{Int32},blx:: Array{T13},bux:: Array{T14}) = inputdata(task,Int32(maxnumcon),Int32(maxnumvar),convert(Array{Float64},c),Float64(cfix),convert(Array{Int64},aptrb),convert(Array{Int64},aptre),convert(Array{Int32},asub),convert(Array{Float64},aval),bkc,convert(Array{Float64},blc),convert(Array{Float64},buc),bkx,convert(Array{Float64},blx),convert(Array{Float64},bux))
...
function inputdata(task_:: MSKtask,maxnumcon_:: Int32,maxnumvar_:: Int32,c_:: Array{Float64},cfix_:: Float64,aptrb_:: Array{Int64},aptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64},bkc_:: Array{Int32},blc_:: Array{Float64},buc_:: Array{Float64},bkx_:: Array{Int32},blx_:: Array{Float64},bux_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "inputdata64",Int32,(Ptr{Void},Int32,Int32,Int32,Int32,Ptr{Float64},Float64,Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Float64},Ptr{Int32},Ptr{Float64},Ptr{Float64},Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,maxnumcon_,maxnumvar_,numcon_,numvar_,c_,cfix_,aptrb_ .- Int32(1),aptre_ .- Int32(1),asub_ .- Int32(1),aval_,bkc_,blc_,buc_,bkx_,blx_,bux_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function isdouparname(task_:: MSKtask,parname_:: AbstractString)
  ...
  res = disable_sigint() do
    @msk_ccall( "isdouparname",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(parname_),param_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function isintparname(task_:: MSKtask,parname_:: AbstractString)
  param_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "isintparname",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(parname_),param_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function isstrparname(task_:: MSKtask,parname_:: AbstractString)
  param_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "isstrparname",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(parname_),param_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    linkfiletostream{T3}(task:: MSKtask,whichstream:: Int32,filename:: AbstractString,append:: T3)
    linkfiletostream(task_:: MSKtask,whichstream_:: Int32,filename_:: AbstractString,append_:: Int32)
...
linkfiletostream{T3}(task:: MSKtask,whichstream:: Int32,filename:: AbstractString,append:: T3) = linkfiletostream(task,whichstream,filename,Int32(append))
function linkfiletostream(task_:: MSKtask,whichstream_:: Int32,filename_:: AbstractString,append_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "linkfiletotaskstream",Int32,(Ptr{Void},Int32,Ptr{UInt8},Int32,),task_.task,whichstream_,string(filename_),append_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    onesolutionsummary(task_:: MSKtask,whichstream_:: Int32,whichsol_:: Int32)
...
function onesolutionsummary(task_:: MSKtask,whichstream_:: Int32,whichsol_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "onesolutionsummary",Int32,(Ptr{Void},Int32,Int32,),task_.task,whichstream_,whichsol_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    optimizersummary(task_:: MSKtask,whichstream_:: Int32)
...
function optimizersummary(task_:: MSKtask,whichstream_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "optimizersummary",Int32,(Ptr{Void},Int32,),task_.task,whichstream_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    primalrepair{T1,T2,T3,T4}(task:: MSKtask,wlc:: Array{T1},wuc:: Array{T2},wlx:: Array{T3},wux:: Array{T4})
    primalrepair(task_:: MSKtask,wlc_:: Array{Float64},wuc_:: Array{Float64},wlx_:: Array{Float64},wux_:: Array{Float64})
...
primalrepair{T1,T2,T3,T4}(task:: MSKtask,wlc:: Array{T1},wuc:: Array{T2},wlx:: Array{T3},wux:: Array{T4}) = primalrepair(task,convert(Array{Float64},wlc),convert(Array{Float64},wuc),convert(Array{Float64},wlx),convert(Array{Float64},wux))
function primalrepair(task_:: MSKtask,wlc_:: Array{Float64},wuc_:: Array{Float64},wlx_:: Array{Float64},wux_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "primalrepair",Int32,(Ptr{Void},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,wlc_,wuc_,wlx_,wux_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    primalsensitivity{T1,T3}(task:: MSKtask,subi:: Array{T1},marki:: Array{Int32},subj:: Array{T3},markj:: Array{Int32})
    primalsensitivity(task_:: MSKtask,subi_:: Array{Int32},marki_:: Array{Int32},subj_:: Array{Int32},markj_:: Array{Int32})

* `task :: MSKtask`. An optimization task.
* `subi :: Array{Int32}`. Indexes of constraints to analyze.
* `marki :: Array{Int32}`. Mark which constraint bounds to analyze.
* `subj :: Array{Int32}`. Indexes of variables to analyze.
* `markj :: Array{Int32}`. Mark which variable bounds to analyze.
...
function primalsensitivity(task_:: MSKtask,subi_:: Array{Int32},marki_:: Array{Int32},subj_:: Array{Int32},markj_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "primalsensitivity",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,numi_,subi_ .- Int32(1),marki_,numj_,subj_ .- Int32(1),markj_,__tmp_var_1,__tmp_var_3,__tmp_var_5,__tmp_var_7,__tmp_var_9,__tmp_var_11,__tmp_var_13,__tmp_var_15)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    printdata{T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,T15}(task:: MSKtask,whichstream:: Int32,firsti:: T2,lasti:: T3,firstj:: T4,lastj:: T5,firstk:: T6,lastk:: T7,c:: T8,qo:: T9,a:: T10,qc:: T11,bc:: T12,bx:: T13,vartype:: T14,cones:: T15)
    printdata(task_:: MSKtask,whichstream_:: Int32,firsti_:: Int32,lasti_:: Int32,firstj_:: Int32,lastj_:: Int32,firstk_:: Int32,lastk_:: Int32,c_:: Int32,qo_:: Int32,a_:: Int32,qc_:: Int32,bc_:: Int32,bx_:: Int32,vartype_:: Int32,cones_:: Int32)
...
function printdata(task_:: MSKtask,whichstream_:: Int32,firsti_:: Int32,lasti_:: Int32,firstj_:: Int32,lastj_:: Int32,firstk_:: Int32,lastk_:: Int32,c_:: Int32,qo_:: Int32,a_:: Int32,qc_:: Int32,bc_:: Int32,bx_:: Int32,vartype_:: Int32,cones_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "printdata",Int32,(Ptr{Void},Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,Int32,),task_.task,whichstream_,firsti_-1,lasti_-1,firstj_-1,lastj_-1,firstk_-1,lastk_-1,c_,qo_,a_,qc_,bc_,bx_,vartype_,cones_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function printparam(task_:: MSKtask)
  res = disable_sigint() do
    @msk_ccall( "printparam",Int32,(Ptr{Void},),task_.task)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putacol{T1,T2,T3}(task:: MSKtask,j:: T1,subj:: Array{T2},valj:: Array{T3})
    putacol(task_:: MSKtask,j_:: Int32,subj_:: Array{Int32},valj_:: Array{Float64})
...
putacol{T1,T2,T3}(task:: MSKtask,j:: T1,subj:: Array{T2},valj:: Array{T3}) = putacol(task,Int32(j),convert(Array{Int32},subj),convert(Array{Float64},valj))
function putacol(task_:: MSKtask,j_:: Int32,subj_:: Array{Int32},valj_:: Array{Float64})
  nzj_ = minimum([ length(subj_),length(valj_) ])
  res = disable_sigint() do
    @msk_ccall( "putacol",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,j_-1,nzj_,subj_ .- Int32(1),valj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putacollist{T1,T2,T3,T4,T5}(task:: MSKtask,sub:: Array{T1},ptrb:: Array{T2},ptre:: Array{T3},asub:: Array{T4},aval:: Array{T5})
    putacollist{T1}(task:: MSKtask,sub:: Array{T1},A:: SparseMatrixCSC{Float64})
    putacollist(task_:: MSKtask,sub_:: Array{Int32},ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
...
putacollist{T1,T2,T3,T4,T5}(task:: MSKtask,sub:: Array{T1},ptrb:: Array{T2},ptre:: Array{T3},asub:: Array{T4},aval:: Array{T5}) = putacollist(task,convert(Array{Int32},sub),convert(Array{Int64},ptrb),convert(Array{Int64},ptre),convert(Array{Int32},asub),convert(Array{Float64},aval))
...
function putacollist(task_:: MSKtask,sub_:: Array{Int32},ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putacollist64",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Float64},),task_.task,num_,sub_ .- Int32(1),ptrb_ .- Int32(1),ptre_ .- Int32(1),asub_ .- Int32(1),aval_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putacolslice{T1,T2,T3,T4,T5,T6}(task:: MSKtask,first:: T1,last:: T2,ptrb:: Array{T3},ptre:: Array{T4},asub:: Array{T5},aval:: Array{T6})
    putacolslice{T1,T2}(task:: MSKtask,first:: T1,last:: T2,A:: SparseMatrixCSC{Float64})
    putacolslice(task_:: MSKtask,first_:: Int32,last_:: Int32,ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
...
putacolslice{T1,T2,T3,T4,T5,T6}(task:: MSKtask,first:: T1,last:: T2,ptrb:: Array{T3},ptre:: Array{T4},asub:: Array{T5},aval:: Array{T6}) = putacolslice(task,Int32(first),Int32(last),convert(Array{Int64},ptrb),convert(Array{Int64},ptre),convert(Array{Int32},asub),convert(Array{Float64},aval))
...
function putaij(task_:: MSKtask,i_:: Int32,j_:: Int32,aij_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putaij",Int32,(Ptr{Void},Int32,Int32,Float64,),task_.task,i_-1,j_-1,aij_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putaijlist{T1,T2,T3}(task:: MSKtask,subi:: Array{T1},subj:: Array{T2},valij:: Array{T3})
    putaijlist(task_:: MSKtask,subi_:: Array{Int32},subj_:: Array{Int32},valij_:: Array{Float64})
...
putaijlist{T1,T2,T3}(task:: MSKtask,subi:: Array{T1},subj:: Array{T2},valij:: Array{T3}) = putaijlist(task,convert(Array{Int32},subi),convert(Array{Int32},subj),convert(Array{Float64},valij))
function putaijlist(task_:: MSKtask,subi_:: Array{Int32},subj_:: Array{Int32},valij_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putaijlist64",Int32,(Ptr{Void},Int64,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,num_,subi_ .- Int32(1),subj_ .- Int32(1),valij_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putarow{T1,T2,T3}(task:: MSKtask,i:: T1,subi:: Array{T2},vali:: Array{T3})
    putarow(task_:: MSKtask,i_:: Int32,subi_:: Array{Int32},vali_:: Array{Float64})
...
putarow{T1,T2,T3}(task:: MSKtask,i:: T1,subi:: Array{T2},vali:: Array{T3}) = putarow(task,Int32(i),convert(Array{Int32},subi),convert(Array{Float64},vali))
function putarow(task_:: MSKtask,i_:: Int32,subi_:: Array{Int32},vali_:: Array{Float64})
  nzi_ = minimum([ length(subi_),length(vali_) ])
  res = disable_sigint() do
    @msk_ccall( "putarow",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},),task_.task,i_-1,nzi_,subi_ .- Int32(1),vali_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putarowlist{T1,T2,T3,T4,T5}(task:: MSKtask,sub:: Array{T1},ptrb:: Array{T2},ptre:: Array{T3},asub:: Array{T4},aval:: Array{T5})
    putarowlist{T1}(task:: MSKtask,sub:: Array{T1},At:: SparseMatrixCSC{Float64})
    putarowlist(task_:: MSKtask,sub_:: Array{Int32},ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
...
putarowlist{T1,T2,T3,T4,T5}(task:: MSKtask,sub:: Array{T1},ptrb:: Array{T2},ptre:: Array{T3},asub:: Array{T4},aval:: Array{T5}) = putarowlist(task,convert(Array{Int32},sub),convert(Array{Int64},ptrb),convert(Array{Int64},ptre),convert(Array{Int32},asub),convert(Array{Float64},aval))
...
function putarowlist(task_:: MSKtask,sub_:: Array{Int32},ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
  num_ = minimum([ length(sub_),length(ptrb_),length(ptre_) ])
  res = disable_sigint() do
    @msk_ccall( "putarowlist64",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Float64},),task_.task,num_,sub_ .- Int32(1),ptrb_ .- Int32(1),ptre_ .- Int32(1),asub_ .- Int32(1),aval_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putarowslice{T1,T2,T3,T4,T5,T6}(task:: MSKtask,first:: T1,last:: T2,ptrb:: Array{T3},ptre:: Array{T4},asub:: Array{T5},aval:: Array{T6})
    putarowslice{T1,T2}(task:: MSKtask,first:: T1,last:: T2,At:: SparseMatrixCSC{Float64})
    putarowslice(task_:: MSKtask,first_:: Int32,last_:: Int32,ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
...
putarowslice{T1,T2,T3,T4,T5,T6}(task:: MSKtask,first:: T1,last:: T2,ptrb:: Array{T3},ptre:: Array{T4},asub:: Array{T5},aval:: Array{T6}) = putarowslice(task,Int32(first),Int32(last),convert(Array{Int64},ptrb),convert(Array{Int64},ptre),convert(Array{Int32},asub),convert(Array{Float64},aval))
...
function putarowslice(task_:: MSKtask,first_:: Int32,last_:: Int32,ptrb_:: Array{Int64},ptre_:: Array{Int64},asub_:: Array{Int32},aval_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putarowslice64",Int32,(Ptr{Void},Int32,Int32,Ptr{Int64},Ptr{Int64},Ptr{Int32},Ptr{Float64},),task_.task,first_-1,last_-1,ptrb_ .- Int32(1),ptre_ .- Int32(1),asub_ .- Int32(1),aval_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbarablocktriplet{T1,T2,T3,T4,T5,T6}(task:: MSKtask,num:: T1,subi:: Array{T2},subj:: Array{T3},subk:: Array{T4},subl:: Array{T5},valijkl:: Array{T6})
    putbarablocktriplet(task_:: MSKtask,num_:: Int64,subi_:: Array{Int32},subj_:: Array{Int32},subk_:: Array{Int32},subl_:: Array{Int32},valijkl_:: Array{Float64})
...
function putbarablocktriplet(task_:: MSKtask,num_:: Int64,subi_:: Array{Int32},subj_:: Array{Int32},subk_:: Array{Int32},subl_:: Array{Int32},valijkl_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putbarablocktriplet",Int32,(Ptr{Void},Int64,Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,num_,subi_ .- Int32(1),subj_ .- Int32(1),subk_ .- Int32(1),subl_ .- Int32(1),valijkl_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbaraij{T1,T2,T3,T4}(task:: MSKtask,i:: T1,j:: T2,sub:: Array{T3},weights:: Array{T4})
    putbaraij(task_:: MSKtask,i_:: Int32,j_:: Int32,sub_:: Array{Int64},weights_:: Array{Float64})
...
putbaraij{T1,T2,T3,T4}(task:: MSKtask,i:: T1,j:: T2,sub:: Array{T3},weights:: Array{T4}) = putbaraij(task,Int32(i),Int32(j),convert(Array{Int64},sub),convert(Array{Float64},weights))
function putbaraij(task_:: MSKtask,i_:: Int32,j_:: Int32,sub_:: Array{Int64},weights_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putbaraij",Int32,(Ptr{Void},Int32,Int32,Int64,Ptr{Int64},Ptr{Float64},),task_.task,i_-1,j_-1,num_,sub_ .- Int32(1),weights_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbarcblocktriplet{T1,T2,T3,T4,T5}(task:: MSKtask,num:: T1,subj:: Array{T2},subk:: Array{T3},subl:: Array{T4},valjkl:: Array{T5})
    putbarcblocktriplet(task_:: MSKtask,num_:: Int64,subj_:: Array{Int32},subk_:: Array{Int32},subl_:: Array{Int32},valjkl_:: Array{Float64})
...
function putbarcblocktriplet(task_:: MSKtask,num_:: Int64,subj_:: Array{Int32},subk_:: Array{Int32},subl_:: Array{Int32},valjkl_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putbarcblocktriplet",Int32,(Ptr{Void},Int64,Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,num_,subj_ .- Int32(1),subk_ .- Int32(1),subl_ .- Int32(1),valjkl_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbarcj{T1,T2,T3}(task:: MSKtask,j:: T1,sub:: Array{T2},weights:: Array{T3})
    putbarcj(task_:: MSKtask,j_:: Int32,sub_:: Array{Int64},weights_:: Array{Float64})
...
putbarcj{T1,T2,T3}(task:: MSKtask,j:: T1,sub:: Array{T2},weights:: Array{T3}) = putbarcj(task,Int32(j),convert(Array{Int64},sub),convert(Array{Float64},weights))
function putbarcj(task_:: MSKtask,j_:: Int32,sub_:: Array{Int64},weights_:: Array{Float64})
  num_ = minimum([ length(sub_),length(weights_) ])
  res = disable_sigint() do
    @msk_ccall( "putbarcj",Int32,(Ptr{Void},Int32,Int64,Ptr{Int64},Ptr{Float64},),task_.task,j_-1,num_,sub_ .- Int32(1),weights_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbarsj{T2,T3}(task:: MSKtask,whichsol:: Int32,j:: T2,barsj:: Array{T3})
    putbarsj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32,barsj_:: Array{Float64})
...
putbarsj{T2,T3}(task:: MSKtask,whichsol:: Int32,j:: T2,barsj:: Array{T3}) = putbarsj(task,whichsol,Int32(j),convert(Array{Float64},barsj))
function putbarsj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32,barsj_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putbarsj",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,whichsol_,j_-1,barsj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
putbarvarname{T1}(task:: MSKtask,j:: T1,name:: AbstractString) = putbarvarname(task,Int32(j),name)
function putbarvarname(task_:: MSKtask,j_:: Int32,name_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "putbarvarname",Int32,(Ptr{Void},Int32,Ptr{UInt8},),task_.task,j_-1,string(name_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbarxj{T2,T3}(task:: MSKtask,whichsol:: Int32,j:: T2,barxj:: Array{T3})
    putbarxj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32,barxj_:: Array{Float64})
...
putbarxj{T2,T3}(task:: MSKtask,whichsol:: Int32,j:: T2,barxj:: Array{T3}) = putbarxj(task,whichsol,Int32(j),convert(Array{Float64},barxj))
function putbarxj(task_:: MSKtask,whichsol_:: Int32,j_:: Int32,barxj_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putbarxj",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,whichsol_,j_-1,barxj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putbound{T2,T4,T5}(task:: MSKtask,accmode:: Int32,i:: T2,bk:: Int32,bl:: T4,bu:: T5)
    putbound(task_:: MSKtask,accmode_:: Int32,i_:: Int32,bk_:: Int32,bl_:: Float64,bu_:: Float64)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines whether the bound for a constraint or a variable is changed.
* `i :: Int32`. Index of the constraint or variable.
* `bk :: Int32`. New bound key.
...
function putbound(task_:: MSKtask,accmode_:: Int32,i_:: Int32,bk_:: Int32,bl_:: Float64,bu_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putbound",Int32,(Ptr{Void},Int32,Int32,Int32,Float64,Float64,),task_.task,accmode_,i_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putboundlist{T2,T4,T5}(task:: MSKtask,accmode:: Int32,sub:: Array{T2},bk:: Array{Int32},bl:: Array{T4},bu:: Array{T5})
    putboundlist(task_:: MSKtask,accmode_:: Int32,sub_:: Array{Int32},bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines whether to access bounds on variables or constraints.
* `sub :: Array{Int32}`. Subscripts of the constraints or variables that should be changed.
* `bk :: Array{Int32}`. Bound keys.
* `bl :: Array{Float64}`. Values for lower bounds.
* `bu :: Array{Float64}`. Values for upper bounds.
...
putboundlist{T2,T4,T5}(task:: MSKtask,accmode:: Int32,sub:: Array{T2},bk:: Array{Int32},bl:: Array{T4},bu:: Array{T5}) = putboundlist(task,accmode,convert(Array{Int32},sub),bk,convert(Array{Float64},bl),convert(Array{Float64},bu))
function putboundlist(task_:: MSKtask,accmode_:: Int32,sub_:: Array{Int32},bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putboundlist",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,accmode_,num_,sub_ .- Int32(1),bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putboundslice{T2,T3,T5,T6}(task:: MSKtask,con:: Int32,first:: T2,last:: T3,bk:: Array{Int32},bl:: Array{T5},bu:: Array{T6})
    putboundslice(task_:: MSKtask,con_:: Int32,first_:: Int32,last_:: Int32,bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})

* `task :: MSKtask`. An optimization task.
* `con :: Int32`. Determines whether variables or constraints are modified.
* `first :: Int32`. First index in the sequence.
* `last :: Int32`. Last index plus 1 in the sequence.
* `bk :: Array{Int32}`. Bound keys.
* `bl :: Array{Float64}`. Values for lower bounds.
...
putboundslice{T2,T3,T5,T6}(task:: MSKtask,con:: Int32,first:: T2,last:: T3,bk:: Array{Int32},bl:: Array{T5},bu:: Array{T6}) = putboundslice(task,con,Int32(first),Int32(last),bk,convert(Array{Float64},bl),convert(Array{Float64},bu))
function putboundslice(task_:: MSKtask,con_:: Int32,first_:: Int32,last_:: Int32,bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putboundslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,con_,first_-1,last_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putcfix(task_:: MSKtask,cfix_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putcfix",Int32,(Ptr{Void},Float64,),task_.task,cfix_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putcj(task_:: MSKtask,j_:: Int32,cj_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putcj",Int32,(Ptr{Void},Int32,Float64,),task_.task,j_-1,cj_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putclist{T1,T2}(task:: MSKtask,subj:: Array{T1},val:: Array{T2})
    putclist(task_:: MSKtask,subj_:: Array{Int32},val_:: Array{Float64})
...
putclist{T1,T2}(task:: MSKtask,subj:: Array{T1},val:: Array{T2}) = putclist(task,convert(Array{Int32},subj),convert(Array{Float64},val))
function putclist(task_:: MSKtask,subj_:: Array{Int32},val_:: Array{Float64})
  num_ = minimum([ length(subj_),length(val_) ])
  res = disable_sigint() do
    @msk_ccall( "putclist",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Float64},),task_.task,num_,subj_ .- Int32(1),val_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putconbound{T1,T3,T4}(task:: MSKtask,i:: T1,bk:: Int32,bl:: T3,bu:: T4)
    putconbound(task_:: MSKtask,i_:: Int32,bk_:: Int32,bl_:: Float64,bu_:: Float64)
...
function putconbound(task_:: MSKtask,i_:: Int32,bk_:: Int32,bl_:: Float64,bu_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putconbound",Int32,(Ptr{Void},Int32,Int32,Float64,Float64,),task_.task,i_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putconboundlist{T1,T3,T4}(task:: MSKtask,sub:: Array{T1},bk:: Array{Int32},bl:: Array{T3},bu:: Array{T4})
    putconboundlist(task_:: MSKtask,sub_:: Array{Int32},bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
...
"""
    putconboundslice{T1,T2,T4,T5}(task:: MSKtask,first:: T1,last:: T2,bk:: Array{Int32},bl:: Array{T4},bu:: Array{T5})
    putconboundslice(task_:: MSKtask,first_:: Int32,last_:: Int32,bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
...
putconboundslice{T1,T2,T4,T5}(task:: MSKtask,first:: T1,last:: T2,bk:: Array{Int32},bl:: Array{T4},bu:: Array{T5}) = putconboundslice(task,Int32(first),Int32(last),bk,convert(Array{Float64},bl),convert(Array{Float64},bu))
function putconboundslice(task_:: MSKtask,first_:: Int32,last_:: Int32,bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putconboundslice",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,first_-1,last_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putcone{T1,T3,T4}(task:: MSKtask,k:: T1,ct:: Int32,conepar:: T3,submem:: Array{T4})
    putcone(task_:: MSKtask,k_:: Int32,ct_:: Int32,conepar_:: Float64,submem_:: Array{Int32})
...
putcone{T1,T3,T4}(task:: MSKtask,k:: T1,ct:: Int32,conepar:: T3,submem:: Array{T4}) = putcone(task,Int32(k),ct,Float64(conepar),convert(Array{Int32},submem))
function putcone(task_:: MSKtask,k_:: Int32,ct_:: Int32,conepar_:: Float64,submem_:: Array{Int32})
  nummem_ = minimum([ length(submem_) ])
  res = disable_sigint() do
    @msk_ccall( "putcone",Int32,(Ptr{Void},Int32,Int32,Float64,Int32,Ptr{Int32},),task_.task,k_-1,ct_,conepar_,nummem_,submem_ .- Int32(1))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
putconename{T1}(task:: MSKtask,j:: T1,name:: AbstractString) = putconename(task,Int32(j),name)
function putconename(task_:: MSKtask,j_:: Int32,name_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "putconename",Int32,(Ptr{Void},Int32,Ptr{UInt8},),task_.task,j_-1,string(name_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
putconname{T1}(task:: MSKtask,i:: T1,name:: AbstractString) = putconname(task,Int32(i),name)
...
"""
    putcslice{T1,T2,T3}(task:: MSKtask,first:: T1,last:: T2,slice:: Array{T3})
    putcslice(task_:: MSKtask,first_:: Int32,last_:: Int32,slice_:: Array{Float64})
...
putcslice{T1,T2,T3}(task:: MSKtask,first:: T1,last:: T2,slice:: Array{T3}) = putcslice(task,Int32(first),Int32(last),convert(Array{Float64},slice))
function putcslice(task_:: MSKtask,first_:: Int32,last_:: Int32,slice_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putcslice",Int32,(Ptr{Void},Int32,Int32,Ptr{Float64},),task_.task,first_-1,last_-1,slice_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putdouparam{T2}(task:: MSKtask,param:: Int32,parvalue:: T2)
    putdouparam(task_:: MSKtask,param_:: Int32,parvalue_:: Float64)
...
function putdouparam(task_:: MSKtask,param_:: Int32,parvalue_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putdouparam",Int32,(Ptr{Void},Int32,Float64,),task_.task,param_,parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putintparam{T2}(task:: MSKtask,param:: Int32,parvalue:: T2)
    putintparam(task_:: MSKtask,param_:: Int32,parvalue_:: Int32)
...
function putintparam(task_:: MSKtask,param_:: Int32,parvalue_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putintparam",Int32,(Ptr{Void},Int32,Int32,),task_.task,param_,parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putmaxnumanz(task_:: MSKtask,maxnumanz_:: Int64)
  res = disable_sigint() do
    @msk_ccall( "putmaxnumanz",Int32,(Ptr{Void},Int64,),task_.task,maxnumanz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putmaxnumbarvar(task_:: MSKtask,maxnumbarvar_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putmaxnumbarvar",Int32,(Ptr{Void},Int32,),task_.task,maxnumbarvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putmaxnumcon(task_:: MSKtask,maxnumcon_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putmaxnumcon",Int32,(Ptr{Void},Int32,),task_.task,maxnumcon_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putmaxnumcone(task_:: MSKtask,maxnumcone_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putmaxnumcone",Int32,(Ptr{Void},Int32,),task_.task,maxnumcone_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putmaxnumqnz(task_:: MSKtask,maxnumqnz_:: Int64)
  res = disable_sigint() do
    @msk_ccall( "putmaxnumqnz",Int32,(Ptr{Void},Int64,),task_.task,maxnumqnz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putmaxnumvar(task_:: MSKtask,maxnumvar_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putmaxnumvar",Int32,(Ptr{Void},Int32,),task_.task,maxnumvar_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
putnadouparam{T2}(task:: MSKtask,paramname:: AbstractString,parvalue:: T2) = putnadouparam(task,paramname,Float64(parvalue))
function putnadouparam(task_:: MSKtask,paramname_:: AbstractString,parvalue_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putnadouparam",Int32,(Ptr{Void},Ptr{UInt8},Float64,),task_.task,string(paramname_),parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
putnaintparam{T2}(task:: MSKtask,paramname:: AbstractString,parvalue:: T2) = putnaintparam(task,paramname,Int32(parvalue))
function putnaintparam(task_:: MSKtask,paramname_:: AbstractString,parvalue_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putnaintparam",Int32,(Ptr{Void},Ptr{UInt8},Int32,),task_.task,string(paramname_),parvalue_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putnastrparam(task_:: MSKtask,paramname_:: AbstractString,parvalue_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "putnastrparam",Int32,(Ptr{Void},Ptr{UInt8},Ptr{UInt8},),task_.task,string(paramname_),string(parvalue_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putobjname(task_:: MSKtask,objname_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "putobjname",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(objname_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putobjsense(task_:: MSKtask,sense_:: Int32)

* `task :: MSKtask`. An optimization task.
* `sense :: Int32`. The objective sense of the task
...
function putobjsense(task_:: MSKtask,sense_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putobjsense",Int32,(Ptr{Void},Int32,),task_.task,sense_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putparam(task_:: MSKtask,parname_:: AbstractString,parvalue_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "putparam",Int32,(Ptr{Void},Ptr{UInt8},Ptr{UInt8},),task_.task,string(parname_),string(parvalue_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putqcon{T1,T2,T3,T4}(task:: MSKtask,qcsubk:: Array{T1},qcsubi:: Array{T2},qcsubj:: Array{T3},qcval:: Array{T4})
    putqcon(task_:: MSKtask,qcsubk_:: Array{Int32},qcsubi_:: Array{Int32},qcsubj_:: Array{Int32},qcval_:: Array{Float64})
...
putqcon{T1,T2,T3,T4}(task:: MSKtask,qcsubk:: Array{T1},qcsubi:: Array{T2},qcsubj:: Array{T3},qcval:: Array{T4}) = putqcon(task,convert(Array{Int32},qcsubk),convert(Array{Int32},qcsubi),convert(Array{Int32},qcsubj),convert(Array{Float64},qcval))
function putqcon(task_:: MSKtask,qcsubk_:: Array{Int32},qcsubi_:: Array{Int32},qcsubj_:: Array{Int32},qcval_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putqcon",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,numqcnz_,qcsubk_ .- Int32(1),qcsubi_ .- Int32(1),qcsubj_ .- Int32(1),qcval_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putqconk{T1,T2,T3,T4}(task:: MSKtask,k:: T1,qcsubi:: Array{T2},qcsubj:: Array{T3},qcval:: Array{T4})
    putqconk{T1}(task:: MSKtask,k:: T1,Qk:: SparseMatrixCSC{Float64})
    putqconk(task_:: MSKtask,k_:: Int32,qcsubi_:: Array{Int32},qcsubj_:: Array{Int32},qcval_:: Array{Float64})
...
putqconk{T1,T2,T3,T4}(task:: MSKtask,k:: T1,qcsubi:: Array{T2},qcsubj:: Array{T3},qcval:: Array{T4}) = putqconk(task,Int32(k),convert(Array{Int32},qcsubi),convert(Array{Int32},qcsubj),convert(Array{Float64},qcval))
...
function putqconk(task_:: MSKtask,k_:: Int32,qcsubi_:: Array{Int32},qcsubj_:: Array{Int32},qcval_:: Array{Float64})
  numqcnz_ = minimum([ length(qcsubi_),length(qcsubj_),length(qcval_) ])
  res = disable_sigint() do
    @msk_ccall( "putqconk",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,k_-1,numqcnz_,qcsubi_ .- Int32(1),qcsubj_ .- Int32(1),qcval_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putqobj{T1,T2,T3}(task:: MSKtask,qosubi:: Array{T1},qosubj:: Array{T2},qoval:: Array{T3})
    putqobj(task:: MSKtask,Qk:: SparseMatrixCSC{Float64})
    putqobj(task_:: MSKtask,qosubi_:: Array{Int32},qosubj_:: Array{Int32},qoval_:: Array{Float64})
...
putqobj{T1,T2,T3}(task:: MSKtask,qosubi:: Array{T1},qosubj:: Array{T2},qoval:: Array{T3}) = putqobj(task,convert(Array{Int32},qosubi),convert(Array{Int32},qosubj),convert(Array{Float64},qoval))
...
function putqobj(task_:: MSKtask,qosubi_:: Array{Int32},qosubj_:: Array{Int32},qoval_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putqobj",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,numqonz_,qosubi_ .- Int32(1),qosubj_ .- Int32(1),qoval_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function putqobjij(task_:: MSKtask,i_:: Int32,j_:: Int32,qoij_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putqobjij",Int32,(Ptr{Void},Int32,Int32,Float64,),task_.task,i_-1,j_-1,qoij_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putskc(task_:: MSKtask,whichsol_:: Int32,skc_:: Array{Int32})
...
function putskc(task_:: MSKtask,whichsol_:: Int32,skc_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "putskc",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,skc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putskcslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,skc:: Array{Int32})
    putskcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,skc_:: Array{Int32})
...
function putskcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,skc_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "putskcslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},),task_.task,whichsol_,first_-1,last_-1,skc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putskx(task_:: MSKtask,whichsol_:: Int32,skx_:: Array{Int32})
...
function putskx(task_:: MSKtask,whichsol_:: Int32,skx_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "putskx",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,skx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putskxslice{T2,T3}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,skx:: Array{Int32})
    putskxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,skx_:: Array{Int32})
...
function putskxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,skx_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "putskxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Int32},),task_.task,whichsol_,first_-1,last_-1,skx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putslc{T2}(task:: MSKtask,whichsol:: Int32,slc:: Array{T2})
    putslc(task_:: MSKtask,whichsol_:: Int32,slc_:: Array{Float64})
...
"""
function putslc end
putslc{T2}(task:: MSKtask,whichsol:: Int32,slc:: Array{T2}) = putslc(task,whichsol,convert(Array{Float64},slc))
function putslc(task_:: MSKtask,whichsol_:: Int32,slc_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putslc",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,slc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putslcslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,slc:: Array{T4})
    putslcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,slc_:: Array{Float64})
...
putslcslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,slc:: Array{T4}) = putslcslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},slc))
function putslcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,slc_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putslcslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,slc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putslx{T2}(task:: MSKtask,whichsol:: Int32,slx:: Array{T2})
    putslx(task_:: MSKtask,whichsol_:: Int32,slx_:: Array{Float64})
...
"""
function putslx end
putslx{T2}(task:: MSKtask,whichsol:: Int32,slx:: Array{T2}) = putslx(task,whichsol,convert(Array{Float64},slx))
function putslx(task_:: MSKtask,whichsol_:: Int32,slx_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putslx",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,slx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putslxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,slx:: Array{T4})
    putslxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,slx_:: Array{Float64})
...
putslxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,slx:: Array{T4}) = putslxslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},slx))
function putslxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,slx_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putslxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,slx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsnx{T2}(task:: MSKtask,whichsol:: Int32,sux:: Array{T2})
    putsnx(task_:: MSKtask,whichsol_:: Int32,sux_:: Array{Float64})
...
"""
function putsnx end
putsnx{T2}(task:: MSKtask,whichsol:: Int32,sux:: Array{T2}) = putsnx(task,whichsol,convert(Array{Float64},sux))
function putsnx(task_:: MSKtask,whichsol_:: Int32,sux_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putsnx",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,sux_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsnxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,snx:: Array{T4})
    putsnxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,snx_:: Array{Float64})
...
putsnxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,snx:: Array{T4}) = putsnxslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},snx))
function putsnxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,snx_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putsnxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,snx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsolution{T5,T6,T7,T8,T9,T10,T11,T12}(task:: MSKtask,whichsol:: Int32,skc:: Array{Int32},skx:: Array{Int32},skn:: Array{Int32},xc:: Array{T5},xx:: Array{T6},y:: Array{T7},slc:: Array{T8},suc:: Array{T9},slx:: Array{T10},sux:: Array{T11},snx:: Array{T12})
    putsolution(task_:: MSKtask,whichsol_:: Int32,skc_:: Array{Int32},skx_:: Array{Int32},skn_:: Array{Int32},xc_:: Array{Float64},xx_:: Array{Float64},y_:: Array{Float64},slc_:: Array{Float64},suc_:: Array{Float64},slx_:: Array{Float64},sux_:: Array{Float64},snx_:: Array{Float64})
...
function putsolution(task_:: MSKtask,whichsol_:: Int32,skc_:: Array{Int32},skx_:: Array{Int32},skn_:: Array{Int32},xc_:: Array{Float64},xx_:: Array{Float64},y_:: Array{Float64},slc_:: Array{Float64},suc_:: Array{Float64},slx_:: Array{Float64},sux_:: Array{Float64},snx_:: Array{Float64})
  res = disable_sigint() do
    @msk_ccall( "putsolution",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Int32},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},),task_.task,whichsol_,skc_,skx_,skn_,xc_,xx_,y_,slc_,suc_,slx_,sux_,snx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsolutioni{T2,T5,T6,T7,T8}(task:: MSKtask,accmode:: Int32,i:: T2,whichsol:: Int32,sk:: Int32,x:: T5,sl:: T6,su:: T7,sn:: T8)
    putsolutioni(task_:: MSKtask,accmode_:: Int32,i_:: Int32,whichsol_:: Int32,sk_:: Int32,x_:: Float64,sl_:: Float64,su_:: Float64,sn_:: Float64)

* `task :: MSKtask`. An optimization task.
* `accmode :: Int32`. Defines whether solution information for a constraint or for a variable is modified.
* `i :: Int32`. Index of the constraint or variable.
* `whichsol :: Int32`. Selects a solution.
* `sk :: Int32`. Status key of the constraint or variable.
...
function putsolutioni(task_:: MSKtask,accmode_:: Int32,i_:: Int32,whichsol_:: Int32,sk_:: Int32,x_:: Float64,sl_:: Float64,su_:: Float64,sn_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putsolutioni",Int32,(Ptr{Void},Int32,Int32,Int32,Int32,Float64,Float64,Float64,Float64,),task_.task,accmode_,i_-1,whichsol_,sk_,x_,sl_,su_,sn_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsolutionyi{T1,T3}(task:: MSKtask,i:: T1,whichsol:: Int32,y:: T3)
    putsolutionyi(task_:: MSKtask,i_:: Int32,whichsol_:: Int32,y_:: Float64)
...
function putsolutionyi(task_:: MSKtask,i_:: Int32,whichsol_:: Int32,y_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putsolutionyi",Int32,(Ptr{Void},Int32,Int32,Float64,),task_.task,i_-1,whichsol_,y_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putstrparam(task_:: MSKtask,param_:: Int32,parvalue_:: AbstractString)
...
function putstrparam(task_:: MSKtask,param_:: Int32,parvalue_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "putstrparam",Int32,(Ptr{Void},Int32,Ptr{UInt8},),task_.task,param_,string(parvalue_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsuc{T2}(task:: MSKtask,whichsol:: Int32,suc:: Array{T2})
    putsuc(task_:: MSKtask,whichsol_:: Int32,suc_:: Array{Float64})
...
"""
function putsuc end
putsuc{T2}(task:: MSKtask,whichsol:: Int32,suc:: Array{T2}) = putsuc(task,whichsol,convert(Array{Float64},suc))
function putsuc(task_:: MSKtask,whichsol_:: Int32,suc_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putsuc",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,suc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsucslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,suc:: Array{T4})
    putsucslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,suc_:: Array{Float64})
...
putsucslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,suc:: Array{T4}) = putsucslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},suc))
function putsucslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,suc_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putsucslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,suc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsux{T2}(task:: MSKtask,whichsol:: Int32,sux:: Array{T2})
    putsux(task_:: MSKtask,whichsol_:: Int32,sux_:: Array{Float64})
...
"""
function putsux end
putsux{T2}(task:: MSKtask,whichsol:: Int32,sux:: Array{T2}) = putsux(task,whichsol,convert(Array{Float64},sux))
function putsux(task_:: MSKtask,whichsol_:: Int32,sux_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putsux",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,sux_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putsuxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,sux:: Array{T4})
    putsuxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,sux_:: Array{Float64})
...
putsuxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,sux:: Array{T4}) = putsuxslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},sux))
function putsuxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,sux_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putsuxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,sux_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function puttaskname(task_:: MSKtask,taskname_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "puttaskname",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(taskname_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putvarbound{T1,T3,T4}(task:: MSKtask,j:: T1,bk:: Int32,bl:: T3,bu:: T4)
    putvarbound(task_:: MSKtask,j_:: Int32,bk_:: Int32,bl_:: Float64,bu_:: Float64)
...
function putvarbound(task_:: MSKtask,j_:: Int32,bk_:: Int32,bl_:: Float64,bu_:: Float64)
  res = disable_sigint() do
    @msk_ccall( "putvarbound",Int32,(Ptr{Void},Int32,Int32,Float64,Float64,),task_.task,j_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putvarboundlist{T1,T3,T4}(task:: MSKtask,sub:: Array{T1},bkx:: Array{Int32},blx:: Array{T3},bux:: Array{T4})
    putvarboundlist(task_:: MSKtask,sub_:: Array{Int32},bkx_:: Array{Int32},blx_:: Array{Float64},bux_:: Array{Float64})
...
putvarboundlist{T1,T3,T4}(task:: MSKtask,sub:: Array{T1},bkx:: Array{Int32},blx:: Array{T3},bux:: Array{T4}) = putvarboundlist(task,convert(Array{Int32},sub),bkx,convert(Array{Float64},blx),convert(Array{Float64},bux))
function putvarboundlist(task_:: MSKtask,sub_:: Array{Int32},bkx_:: Array{Int32},blx_:: Array{Float64},bux_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putvarboundlist",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,num_,sub_ .- Int32(1),bkx_,blx_,bux_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putvarboundslice{T1,T2,T4,T5}(task:: MSKtask,first:: T1,last:: T2,bk:: Array{Int32},bl:: Array{T4},bu:: Array{T5})
    putvarboundslice(task_:: MSKtask,first_:: Int32,last_:: Int32,bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
...
putvarboundslice{T1,T2,T4,T5}(task:: MSKtask,first:: T1,last:: T2,bk:: Array{Int32},bl:: Array{T4},bu:: Array{T5}) = putvarboundslice(task,Int32(first),Int32(last),bk,convert(Array{Float64},bl),convert(Array{Float64},bu))
function putvarboundslice(task_:: MSKtask,first_:: Int32,last_:: Int32,bk_:: Array{Int32},bl_:: Array{Float64},bu_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putvarboundslice",Int32,(Ptr{Void},Int32,Int32,Ptr{Int32},Ptr{Float64},Ptr{Float64},),task_.task,first_-1,last_-1,bk_,bl_,bu_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putvartype{T1}(task:: MSKtask,j:: T1,vartype:: Int32)
    putvartype(task_:: MSKtask,j_:: Int32,vartype_:: Int32)

* `task :: MSKtask`. An optimization task.
* `j :: Int32`. Index of the variable.
* `vartype :: Int32`. The new variable type.
...
function putvartype(task_:: MSKtask,j_:: Int32,vartype_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "putvartype",Int32,(Ptr{Void},Int32,Int32,),task_.task,j_-1,vartype_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putvartypelist{T1}(task:: MSKtask,subj:: Array{T1},vartype:: Array{Int32})
    putvartypelist(task_:: MSKtask,subj_:: Array{Int32},vartype_:: Array{Int32})

* `task :: MSKtask`. An optimization task.
* `subj :: Array{Int32}`. A list of variable indexes for which the variable type should be changed.
* `vartype :: Array{Int32}`. A list of variable types.
...
putvartypelist{T1}(task:: MSKtask,subj:: Array{T1},vartype:: Array{Int32}) = putvartypelist(task,convert(Array{Int32},subj),vartype)
function putvartypelist(task_:: MSKtask,subj_:: Array{Int32},vartype_:: Array{Int32})
  num_ = minimum([ length(subj_),length(vartype_) ])
  res = disable_sigint() do
    @msk_ccall( "putvartypelist",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},),task_.task,num_,subj_ .- Int32(1),vartype_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putxc(task_:: MSKtask,whichsol_:: Int32)
...
function putxc(task_:: MSKtask,whichsol_:: Int32)
  ...
  xc_ = __tmp_var_1
  res = disable_sigint() do
    @msk_ccall( "putxc",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,__tmp_var_1)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putxcslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,xc:: Array{T4})
    putxcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,xc_:: Array{Float64})
...
putxcslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,xc:: Array{T4}) = putxcslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},xc))
function putxcslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,xc_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putxcslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,xc_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putxx{T2}(task:: MSKtask,whichsol:: Int32,xx:: Array{T2})
    putxx(task_:: MSKtask,whichsol_:: Int32,xx_:: Array{Float64})
...
"""
function putxx end
putxx{T2}(task:: MSKtask,whichsol:: Int32,xx:: Array{T2}) = putxx(task,whichsol,convert(Array{Float64},xx))
function putxx(task_:: MSKtask,whichsol_:: Int32,xx_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putxx",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,xx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putxxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,xx:: Array{T4})
    putxxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,xx_:: Array{Float64})
...
putxxslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,xx:: Array{T4}) = putxxslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},xx))
function putxxslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,xx_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putxxslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,xx_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    puty{T2}(task:: MSKtask,whichsol:: Int32,y:: Array{T2})
    puty(task_:: MSKtask,whichsol_:: Int32,y_:: Array{Float64})
...
"""
function puty end
puty{T2}(task:: MSKtask,whichsol:: Int32,y:: Array{T2}) = puty(task,whichsol,convert(Array{Float64},y))
function puty(task_:: MSKtask,whichsol_:: Int32,y_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "puty",Int32,(Ptr{Void},Int32,Ptr{Float64},),task_.task,whichsol_,y_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    putyslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,y:: Array{T4})
    putyslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,y_:: Array{Float64})
...
putyslice{T2,T3,T4}(task:: MSKtask,whichsol:: Int32,first:: T2,last:: T3,y:: Array{T4}) = putyslice(task,whichsol,Int32(first),Int32(last),convert(Array{Float64},y))
function putyslice(task_:: MSKtask,whichsol_:: Int32,first_:: Int32,last_:: Int32,y_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "putyslice",Int32,(Ptr{Void},Int32,Int32,Int32,Ptr{Float64},),task_.task,whichsol_,first_-1,last_-1,y_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function readdata(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "readdataautoformat",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    readdataformat(task_:: MSKtask,filename_:: AbstractString,format_:: Int32,compress_:: Int32)

* `task :: MSKtask`. An optimization task.
* `filename :: String`. A valid file name.
* `format :: Int32`. File data format.
* `compress :: Int32`. File compression type.
...
function readdataformat(task_:: MSKtask,filename_:: AbstractString,format_:: Int32,compress_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "readdataformat",Int32,(Ptr{Void},Ptr{UInt8},Int32,Int32,),task_.task,string(filename_),format_,compress_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function readparamfile(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "readparamfile",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    readsolution(task_:: MSKtask,whichsol_:: Int32,filename_:: AbstractString)
...
function readsolution(task_:: MSKtask,whichsol_:: Int32,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "readsolution",Int32,(Ptr{Void},Int32,Ptr{UInt8},),task_.task,whichsol_,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    readsummary(task_:: MSKtask,whichstream_:: Int32)
...
function readsummary(task_:: MSKtask,whichstream_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "readsummary",Int32,(Ptr{Void},Int32,),task_.task,whichstream_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function readtask(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "readtask",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    removebarvars{T1}(task:: MSKtask,subset:: Array{T1})
    removebarvars(task_:: MSKtask,subset_:: Array{Int32})
...
function removebarvars(task_:: MSKtask,subset_:: Array{Int32})
  ...
  res = disable_sigint() do
    @msk_ccall( "removebarvars",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,num_,subset_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    removecones{T1}(task:: MSKtask,subset:: Array{T1})
    removecones(task_:: MSKtask,subset_:: Array{Int32})
...
function removecones(task_:: MSKtask,subset_:: Array{Int32})
  num_ = minimum([ length(subset_) ])
  res = disable_sigint() do
    @msk_ccall( "removecones",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,num_,subset_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    removecons{T1}(task:: MSKtask,subset:: Array{T1})
    removecons(task_:: MSKtask,subset_:: Array{Int32})
...
function removecons(task_:: MSKtask,subset_:: Array{Int32})
  num_ = minimum([ length(subset_) ])
  res = disable_sigint() do
    @msk_ccall( "removecons",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,num_,subset_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    removevars{T1}(task:: MSKtask,subset:: Array{T1})
    removevars(task_:: MSKtask,subset_:: Array{Int32})
...
function removevars(task_:: MSKtask,subset_:: Array{Int32})
  num_ = minimum([ length(subset_) ])
  res = disable_sigint() do
    @msk_ccall( "removevars",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,num_,subset_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function resizetask(task_:: MSKtask,maxnumcon_:: Int32,maxnumvar_:: Int32,maxnumcone_:: Int32,maxnumanz_:: Int64,maxnumqnz_:: Int64)
  res = disable_sigint() do
    @msk_ccall( "resizetask",Int32,(Ptr{Void},Int32,Int32,Int32,Int64,Int64,),task_.task,maxnumcon_,maxnumvar_,maxnumcone_,maxnumanz_,maxnumqnz_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    sensitivityreport(task_:: MSKtask,whichstream_:: Int32)
...
function sensitivityreport(task_:: MSKtask,whichstream_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "sensitivityreport",Int32,(Ptr{Void},Int32,),task_.task,whichstream_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function setdefaults(task_:: MSKtask)
  res = disable_sigint() do
    @msk_ccall( "setdefaults",Int32,(Ptr{Void},),task_.task)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    solutiondef(task_:: MSKtask,whichsol_:: Int32)
...
function solutiondef(task_:: MSKtask,whichsol_:: Int32)
  ...
  res = disable_sigint() do
    @msk_ccall( "solutiondef",Int32,(Ptr{Void},Int32,Ptr{Int32},),task_.task,whichsol_,isdef_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    solutionsummary(task_:: MSKtask,whichstream_:: Int32)
...
function solutionsummary(task_:: MSKtask,whichstream_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "solutionsummary",Int32,(Ptr{Void},Int32,),task_.task,whichstream_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    solvewithbasis{T1,T2,T3,T4}(task:: MSKtask,transp:: T1,numnz:: T2,sub:: Array{T3},val:: Array{T4})
    solvewithbasis(task_:: MSKtask,transp_:: Int32,numnz_:: Int32,sub_:: Array{Int32},val_:: Array{Float64})
...
solvewithbasis{T1,T2,T3,T4}(task:: MSKtask,transp:: T1,numnz:: T2,sub:: Array{T3},val:: Array{T4}) = solvewithbasis(task,Int32(transp),Int32(numnz),convert(Array{Int32},sub),convert(Array{Float64},val))
function solvewithbasis(task_:: MSKtask,transp_:: Int32,numnz_:: Int32,sub_:: Array{Int32},val_:: Array{Float64})
  ...
  res = disable_sigint() do
    @msk_ccall( "solvewithbasis",Int32,(Ptr{Void},Int32,Ptr{Int32},Ptr{Int32},Ptr{Float64},),task_.task,transp_,__tmp_var_0,sub_ .- Int32(1),val_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function strtoconetype(task_:: MSKtask,str_:: AbstractString)
  ...
  res = disable_sigint() do
    @msk_ccall( "strtoconetype",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(str_),conetype_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function strtosk(task_:: MSKtask,str_:: AbstractString)
  sk_ = Array{Int32}((1,))
  res = disable_sigint() do
    @msk_ccall( "strtosk",Int32,(Ptr{Void},Ptr{UInt8},Ptr{Int32},),task_.task,string(str_),sk_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    updatesolutioninfo(task_:: MSKtask,whichsol_:: Int32)
...
function updatesolutioninfo(task_:: MSKtask,whichsol_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "updatesolutioninfo",Int32,(Ptr{Void},Int32,),task_.task,whichsol_)
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function writedata(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "writedata",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function writejsonsol(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "writejsonsol",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function writeparamfile(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "writeparamfile",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    writesolution(task_:: MSKtask,whichsol_:: Int32,filename_:: AbstractString)
...
function writesolution(task_:: MSKtask,whichsol_:: Int32,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "writesolution",Int32,(Ptr{Void},Int32,Ptr{UInt8},),task_.task,whichsol_,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
function writetask(task_:: MSKtask,filename_:: AbstractString)
  res = disable_sigint() do
    @msk_ccall( "writetask",Int32,(Ptr{Void},Ptr{UInt8},),task_.task,string(filename_))
  end
  if res != MSK_RES_OK
    msg = getlasterror(task_)
    throw(MosekError(res,msg))
...
"""
    checkinlicense(env_:: MSKenv,feature_:: Int32)

* `env :: MSKenv`. The MOSEK environment.
* `feature :: Int32`. Feature to check in to the license system.
...
function checkinlicense(env_:: MSKenv,feature_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "checkinlicense",Int32,(Ptr{Void},Int32,),env_.env,feature_)
  end
  if res != 0
    throw(MosekError(res,""))
  end
...
"""
    checkoutlicense(env_:: MSKenv,feature_:: Int32)

* `env :: MSKenv`. The MOSEK environment.
* `feature :: Int32`. Feature to check out from the license system.
...
function checkoutlicense(env_:: MSKenv,feature_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "checkoutlicense",Int32,(Ptr{Void},Int32,),env_.env,feature_)
  end
  if res != 0
    throw(MosekError(res,""))
  end
...
"""
    getcodedesc(code_:: Int32)

* `code :: Int32`. A valid response code.
...
"""
    linkfiletostream{T3}(env:: MSKenv,whichstream:: Int32,filename:: AbstractString,append:: T3)
    linkfiletostream(env_:: MSKenv,whichstream_:: Int32,filename_:: AbstractString,append_:: Int32)
...
function linkfiletostream(env_:: MSKenv,whichstream_:: Int32,filename_:: AbstractString,append_:: Int32)
  res = disable_sigint() do
    @msk_ccall( "linkfiletoenvstream",Int32,(Ptr{Void},Int32,Ptr{UInt8},Int32,),env_.env,whichstream_,string(filename_),append_)
  end
  if res != 0
    throw(MosekError(res,""))
  end
...
"""
    putlicensecode{T1}(env:: MSKenv,code:: Array{T1})
    putlicensecode(env_:: MSKenv,code_:: Array{Int32})
...
putlicensecode{T1}(env:: MSKenv,code:: Array{T1}) = putlicensecode(env,convert(Array{Int32},code))
