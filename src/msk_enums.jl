...
export
  ...
  MSK_DPAR_MIO_PRESOLVE_AGGREGATOR_TOL_PIVOT,
  ...
  MSK_IPAR_MIO_PRESOLVE_AGGREGATOR_MAX_FILL,
...
const Checkconvexitytype_members = Checkconvexitytype[
    MSK_CHECK_CONVEXITY_NONE,
    MSK_CHECK_CONVEXITY_SIMPLE,
    MSK_CHECK_CONVEXITY_FULL ]
...
* `MSK_DINF_SOL_ITR_DVIOLACC`. Maximal violation for dual conic constraints in the interior-point solution. Updated by the function updatesolutioninfo.
...
* `MSK_DINF_SOL_ITR_PVIOLACC`. Maximal violation for primal affine conic constraints in the interior-point solution. Updated by the function updatesolutioninfo.
...
const MSK_DINF_MIO_LIPRO_SEPARATION_TIME = Dinfitem(21)
...
const MSK_DINF_MIO_PROBING_TIME = Dinfitem(26)

"Total time for cut generation."
const MSK_DINF_MIO_ROOT_CUTGEN_TIME = Dinfitem(27)

"Time spent in the contiuous optimizer while processing the root node relaxation."
const MSK_DINF_MIO_ROOT_OPTIMIZER_TIME = Dinfitem(28)

"Time spent presolving the problem at the root node."
const MSK_DINF_MIO_ROOT_PRESOLVE_TIME = Dinfitem(29)

"Time spent processing the root node."
const MSK_DINF_MIO_ROOT_TIME = Dinfitem(30)
...
tostr(v::Dinfitem) = if v.value == 0 "Mosek.MSK_DINF_BI_CLEAN_DUAL_TIME"
  ...
  elseif v.value == 21 "Mosek.MSK_DINF_MIO_LIPRO_SEPARATION_TIME"
  ...
  elseif v.value == 26 "Mosek.MSK_DINF_MIO_PROBING_TIME"
  elseif v.value == 27 "Mosek.MSK_DINF_MIO_ROOT_CUTGEN_TIME"
  elseif v.value == 28 "Mosek.MSK_DINF_MIO_ROOT_OPTIMIZER_TIME"
  elseif v.value == 29 "Mosek.MSK_DINF_MIO_ROOT_PRESOLVE_TIME"
  elseif v.value == 30 "Mosek.MSK_DINF_MIO_ROOT_TIME"
  ...
  elseif v.value == 37 "Mosek.MSK_DINF_PRESOLVE_TOTAL_PRIMAL_PERTURBATION"
  elseif v.value == 38 "Mosek.MSK_DINF_PRIMAL_REPAIR_PENALTY_OBJ"
  elseif v.value == 39 "Mosek.MSK_DINF_QCQO_REFORMULATE_MAX_PERTURBATION"
  elseif v.value == 40 "Mosek.MSK_DINF_QCQO_REFORMULATE_TIME"
  elseif v.value == 41 "Mosek.MSK_DINF_QCQO_REFORMULATE_WORST_CHOLESKY_COLUMN_SCALING"
  elseif v.value == 42 "Mosek.MSK_DINF_QCQO_REFORMULATE_WORST_CHOLESKY_DIAG_SCALING"
  elseif v.value == 43 "Mosek.MSK_DINF_RD_TIME"
  elseif v.value == 44 "Mosek.MSK_DINF_SIM_DUAL_TIME"
  elseif v.value == 45 "Mosek.MSK_DINF_SIM_FEAS"
  elseif v.value == 46 "Mosek.MSK_DINF_SIM_OBJ"
  elseif v.value == 47 "Mosek.MSK_DINF_SIM_PRIMAL_TIME"
  elseif v.value == 48 "Mosek.MSK_DINF_SIM_TIME"
  elseif v.value == 49 "Mosek.MSK_DINF_SOL_BAS_DUAL_OBJ"
  elseif v.value == 50 "Mosek.MSK_DINF_SOL_BAS_DVIOLCON"
  elseif v.value == 51 "Mosek.MSK_DINF_SOL_BAS_DVIOLVAR"
  elseif v.value == 52 "Mosek.MSK_DINF_SOL_BAS_NRM_BARX"
  elseif v.value == 53 "Mosek.MSK_DINF_SOL_BAS_NRM_SLC"
  elseif v.value == 54 "Mosek.MSK_DINF_SOL_BAS_NRM_SLX"
  elseif v.value == 55 "Mosek.MSK_DINF_SOL_BAS_NRM_SUC"
  elseif v.value == 56 "Mosek.MSK_DINF_SOL_BAS_NRM_SUX"
  elseif v.value == 57 "Mosek.MSK_DINF_SOL_BAS_NRM_XC"
  elseif v.value == 58 "Mosek.MSK_DINF_SOL_BAS_NRM_XX"
  elseif v.value == 59 "Mosek.MSK_DINF_SOL_BAS_NRM_Y"
  elseif v.value == 60 "Mosek.MSK_DINF_SOL_BAS_PRIMAL_OBJ"
  elseif v.value == 61 "Mosek.MSK_DINF_SOL_BAS_PVIOLCON"
  elseif v.value == 62 "Mosek.MSK_DINF_SOL_BAS_PVIOLVAR"
  elseif v.value == 63 "Mosek.MSK_DINF_SOL_ITG_NRM_BARX"
  elseif v.value == 64 "Mosek.MSK_DINF_SOL_ITG_NRM_XC"
  elseif v.value == 65 "Mosek.MSK_DINF_SOL_ITG_NRM_XX"
  elseif v.value == 66 "Mosek.MSK_DINF_SOL_ITG_PRIMAL_OBJ"
  elseif v.value == 67 "Mosek.MSK_DINF_SOL_ITG_PVIOLBARVAR"
  elseif v.value == 68 "Mosek.MSK_DINF_SOL_ITG_PVIOLCON"
  elseif v.value == 69 "Mosek.MSK_DINF_SOL_ITG_PVIOLCONES"
  elseif v.value == 70 "Mosek.MSK_DINF_SOL_ITG_PVIOLITG"
  elseif v.value == 71 "Mosek.MSK_DINF_SOL_ITG_PVIOLVAR"
  elseif v.value == 72 "Mosek.MSK_DINF_SOL_ITR_DUAL_OBJ"
  elseif v.value == 73 "Mosek.MSK_DINF_SOL_ITR_DVIOLACC"
  elseif v.value == 74 "Mosek.MSK_DINF_SOL_ITR_DVIOLBARVAR"
  elseif v.value == 75 "Mosek.MSK_DINF_SOL_ITR_DVIOLCON"
  elseif v.value == 76 "Mosek.MSK_DINF_SOL_ITR_DVIOLCONES"
  elseif v.value == 77 "Mosek.MSK_DINF_SOL_ITR_DVIOLVAR"
  elseif v.value == 78 "Mosek.MSK_DINF_SOL_ITR_NRM_BARS"
  elseif v.value == 79 "Mosek.MSK_DINF_SOL_ITR_NRM_BARX"
  elseif v.value == 80 "Mosek.MSK_DINF_SOL_ITR_NRM_SLC"
  elseif v.value == 81 "Mosek.MSK_DINF_SOL_ITR_NRM_SLX"
  elseif v.value == 82 "Mosek.MSK_DINF_SOL_ITR_NRM_SNX"
  elseif v.value == 83 "Mosek.MSK_DINF_SOL_ITR_NRM_SUC"
  elseif v.value == 84 "Mosek.MSK_DINF_SOL_ITR_NRM_SUX"
  elseif v.value == 85 "Mosek.MSK_DINF_SOL_ITR_NRM_XC"
  elseif v.value == 86 "Mosek.MSK_DINF_SOL_ITR_NRM_XX"
  elseif v.value == 87 "Mosek.MSK_DINF_SOL_ITR_NRM_Y"
  elseif v.value == 88 "Mosek.MSK_DINF_SOL_ITR_PRIMAL_OBJ"
  elseif v.value == 89 "Mosek.MSK_DINF_SOL_ITR_PVIOLACC"
  elseif v.value == 90 "Mosek.MSK_DINF_SOL_ITR_PVIOLBARVAR"
  elseif v.value == 91 "Mosek.MSK_DINF_SOL_ITR_PVIOLCON"
  elseif v.value == 92 "Mosek.MSK_DINF_SOL_ITR_PVIOLCONES"
  elseif v.value == 93 "Mosek.MSK_DINF_SOL_ITR_PVIOLVAR"
  elseif v.value == 94 "Mosek.MSK_DINF_TO_CONIC_TIME"
  else "Mosek.Dinfitem(?)"
  end
...
* `MSK_DPAR_MIO_PRESOLVE_AGGREGATOR_TOL_PIVOT`. Tolerance used to prevent numerically problematic substitutions by the aggregator.
...
"""
Tolerance used to prevent numerically problematic substitutions by the aggregator.

Default value: `0.0`

Possible Values: Any number between 0 and 1.
"""
const MSK_DPAR_MIO_PRESOLVE_AGGREGATOR_TOL_PIVOT = Dparam(42)
...
tostr(v::Dparam) = if v.value == 0 "Mosek.MSK_DPAR_ANA_SOL_INFEAS_TOL"
  ...
  elseif v.value == 42 "Mosek.MSK_DPAR_MIO_PRESOLVE_AGGREGATOR_TOL_PIVOT"
...
tostr(v::Iinfitem) = if v.value == 0 "Mosek.MSK_IINF_ANA_PRO_NUM_CON"
  ...
  elseif v.value == 31 "Mosek.MSK_IINF_MIO_NUM_LIPRO_CUTS"
  elseif v.value == 32 "Mosek.MSK_IINF_MIO_NUM_RELAX"
  elseif v.value == 33 "Mosek.MSK_IINF_MIO_NUM_REPEATED_PRESOLVE"
  elseif v.value == 34 "Mosek.MSK_IINF_MIO_NUMBIN"
  elseif v.value == 35 "Mosek.MSK_IINF_MIO_NUMBINCONEVAR"
  elseif v.value == 36 "Mosek.MSK_IINF_MIO_NUMCON"
  elseif v.value == 37 "Mosek.MSK_IINF_MIO_NUMCONE"
  elseif v.value == 38 "Mosek.MSK_IINF_MIO_NUMCONEVAR"
  elseif v.value == 39 "Mosek.MSK_IINF_MIO_NUMCONT"
  elseif v.value == 40 "Mosek.MSK_IINF_MIO_NUMCONTCONEVAR"
  elseif v.value == 41 "Mosek.MSK_IINF_MIO_NUMDEXPCONES"
  elseif v.value == 42 "Mosek.MSK_IINF_MIO_NUMDJC"
  elseif v.value == 43 "Mosek.MSK_IINF_MIO_NUMDPOWCONES"
  elseif v.value == 44 "Mosek.MSK_IINF_MIO_NUMINT"
  elseif v.value == 45 "Mosek.MSK_IINF_MIO_NUMINTCONEVAR"
  elseif v.value == 46 "Mosek.MSK_IINF_MIO_NUMPEXPCONES"
  elseif v.value == 47 "Mosek.MSK_IINF_MIO_NUMPPOWCONES"
  elseif v.value == 48 "Mosek.MSK_IINF_MIO_NUMQCONES"
  elseif v.value == 49 "Mosek.MSK_IINF_MIO_NUMRQCONES"
  elseif v.value == 50 "Mosek.MSK_IINF_MIO_NUMVAR"
  elseif v.value == 51 "Mosek.MSK_IINF_MIO_OBJ_BOUND_DEFINED"
  elseif v.value == 52 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMBIN"
  elseif v.value == 53 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMBINCONEVAR"
  elseif v.value == 54 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMCON"
  elseif v.value == 55 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMCONE"
  elseif v.value == 56 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMCONEVAR"
  elseif v.value == 57 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMCONT"
  elseif v.value == 58 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMCONTCONEVAR"
  elseif v.value == 59 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMDEXPCONES"
  elseif v.value == 60 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMDJC"
  elseif v.value == 61 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMDPOWCONES"
  elseif v.value == 62 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMINT"
  elseif v.value == 63 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMINTCONEVAR"
  elseif v.value == 64 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMPEXPCONES"
  elseif v.value == 65 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMPPOWCONES"
  elseif v.value == 66 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMQCONES"
  elseif v.value == 67 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMRQCONES"
  elseif v.value == 68 "Mosek.MSK_IINF_MIO_PRESOLVED_NUMVAR"
  elseif v.value == 69 "Mosek.MSK_IINF_MIO_RELGAP_SATISFIED"
  elseif v.value == 70 "Mosek.MSK_IINF_MIO_TOTAL_NUM_CUTS"
  elseif v.value == 71 "Mosek.MSK_IINF_MIO_USER_OBJ_CUT"
  elseif v.value == 72 "Mosek.MSK_IINF_OPT_NUMCON"
  elseif v.value == 73 "Mosek.MSK_IINF_OPT_NUMVAR"
  elseif v.value == 74 "Mosek.MSK_IINF_OPTIMIZE_RESPONSE"
  elseif v.value == 75 "Mosek.MSK_IINF_PRESOLVE_NUM_PRIMAL_PERTURBATIONS"
  elseif v.value == 76 "Mosek.MSK_IINF_PURIFY_DUAL_SUCCESS"
  elseif v.value == 77 "Mosek.MSK_IINF_PURIFY_PRIMAL_SUCCESS"
  elseif v.value == 78 "Mosek.MSK_IINF_RD_NUMBARVAR"
  elseif v.value == 79 "Mosek.MSK_IINF_RD_NUMCON"
  elseif v.value == 80 "Mosek.MSK_IINF_RD_NUMCONE"
  elseif v.value == 81 "Mosek.MSK_IINF_RD_NUMINTVAR"
  elseif v.value == 82 "Mosek.MSK_IINF_RD_NUMQ"
  elseif v.value == 83 "Mosek.MSK_IINF_RD_NUMVAR"
  elseif v.value == 84 "Mosek.MSK_IINF_RD_PROTYPE"
  elseif v.value == 85 "Mosek.MSK_IINF_SIM_DUAL_DEG_ITER"
  elseif v.value == 86 "Mosek.MSK_IINF_SIM_DUAL_HOTSTART"
  elseif v.value == 87 "Mosek.MSK_IINF_SIM_DUAL_HOTSTART_LU"
  elseif v.value == 88 "Mosek.MSK_IINF_SIM_DUAL_INF_ITER"
  elseif v.value == 89 "Mosek.MSK_IINF_SIM_DUAL_ITER"
  elseif v.value == 90 "Mosek.MSK_IINF_SIM_NUMCON"
  elseif v.value == 91 "Mosek.MSK_IINF_SIM_NUMVAR"
  elseif v.value == 92 "Mosek.MSK_IINF_SIM_PRIMAL_DEG_ITER"
  elseif v.value == 93 "Mosek.MSK_IINF_SIM_PRIMAL_HOTSTART"
  elseif v.value == 94 "Mosek.MSK_IINF_SIM_PRIMAL_HOTSTART_LU"
  elseif v.value == 95 "Mosek.MSK_IINF_SIM_PRIMAL_INF_ITER"
  elseif v.value == 96 "Mosek.MSK_IINF_SIM_PRIMAL_ITER"
  elseif v.value == 97 "Mosek.MSK_IINF_SIM_SOLVE_DUAL"
  elseif v.value == 98 "Mosek.MSK_IINF_SOL_BAS_PROSTA"
  elseif v.value == 99 "Mosek.MSK_IINF_SOL_BAS_SOLSTA"
  elseif v.value == 100 "Mosek.MSK_IINF_SOL_ITG_PROSTA"
  elseif v.value == 101 "Mosek.MSK_IINF_SOL_ITG_SOLSTA"
  elseif v.value == 102 "Mosek.MSK_IINF_SOL_ITR_PROSTA"
  elseif v.value == 103 "Mosek.MSK_IINF_SOL_ITR_SOLSTA"
  elseif v.value == 104 "Mosek.MSK_IINF_STO_NUM_A_REALLOC"
  else "Mosek.Iinfitem(?)"
  end
...
* `MSK_IPAR_MIO_NUMERICAL_EMPHASIS_LEVEL`. Controls The effort .
* `MSK_IPAR_MIO_PERSPECTIVE_REFORMULATE`. Enables or disables perspective reformulation in presolve.
* `MSK_IPAR_MIO_PRESOLVE_AGGREGATOR_MAX_FILL`. Controls the amount of fill that presolve is allowed to add when substituting variables
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_CUT_CLIQUE = Iparam(62)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_CUT_CMIR = Iparam(63)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_CUT_GMI = Iparam(64)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_CUT_IMPLIED_BOUND = Iparam(65)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_CUT_KNAPSACK_COVER = Iparam(66)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_CUT_LIPRO = Iparam(67)
...
"""
const MSK_IPAR_MIO_DATA_PERMUTATION_METHOD = Iparam(69)
...
"""
const MSK_IPAR_MIO_MODE = Iparam(77)
...
* `MSK_OPTIMIZER_MIXED_INT`. The mixed-integer optimizer.
"""
const MSK_IPAR_MIO_NODE_OPTIMIZER = Iparam(78)
...
"""
const MSK_IPAR_MIO_NODE_SELECTION = Iparam(79)
...
Possible Values: Any number between -1 and +2.
"""
const MSK_IPAR_MIO_NUMERICAL_EMPHASIS_LEVEL = Iparam(80)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_MIO_PERSPECTIVE_REFORMULATE = Iparam(81)

"""
Controls the amount of fill that presolve is allowed to add when substituting variables

Default value: `-1`

Possible Values: Any number between -1 and 1000.
"""
const MSK_IPAR_MIO_PRESOLVE_AGGREGATOR_MAX_FILL = Iparam(82)
...
Possible Values: Any number between -1 and +inf.
"""
const MSK_IPAR_MIO_RINS_MAX_NODES = Iparam(86)
...
* `MSK_OPTIMIZER_MIXED_INT`. The mixed-integer optimizer.
"""
const MSK_IPAR_MIO_ROOT_OPTIMIZER = Iparam(87)
...
Possible Values: Any number between -1 and 1.
"""
const MSK_IPAR_MIO_ROOT_REPEAT_PRESOLVE_LEVEL = Iparam(88)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_MIO_SEED = Iparam(89)
...
Possible Values: Any number between -1 and +2.
"""
const MSK_IPAR_MIO_VB_DETECTION_LEVEL = Iparam(90)
...
"""
const MSK_IPAR_MT_SPINCOUNT = Iparam(91)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_NUM_THREADS = Iparam(93)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_HEADER = Iparam(94)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_HINTS = Iparam(95)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_OPF_WRITE_LINE_LENGTH = Iparam(96)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_PARAMETERS = Iparam(97)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_PROBLEM = Iparam(98)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_SOL_BAS = Iparam(99)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_SOL_ITG = Iparam(100)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_SOL_ITR = Iparam(101)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_OPF_WRITE_SOLUTIONS = Iparam(102)
...
* `MSK_OPTIMIZER_MIXED_INT`. The mixed-integer optimizer.
"""
const MSK_IPAR_OPTIMIZER = Iparam(103)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_PARAM_READ_CASE_NAME = Iparam(104)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_PARAM_READ_IGN_ERROR = Iparam(105)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_FILL = Iparam(106)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_NUM_TRIES = Iparam(107)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_LEVEL = Iparam(108)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_LINDEP_ABS_WORK_TRH = Iparam(109)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_LINDEP_REL_WORK_TRH = Iparam(110)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_PRESOLVE_LINDEP_USE = Iparam(111)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_MAX_NUM_PASS = Iparam(112)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_PRESOLVE_MAX_NUM_REDUCTIONS = Iparam(113)
...
"""
const MSK_IPAR_PRESOLVE_USE = Iparam(114)
...
* `MSK_OPTIMIZER_MIXED_INT`. The mixed-integer optimizer.
"""
const MSK_IPAR_PRIMAL_REPAIR_OPTIMIZER = Iparam(115)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_PTF_WRITE_TRANSFORM = Iparam(116)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_READ_DEBUG = Iparam(117)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_READ_KEEP_FREE_CON = Iparam(118)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_READ_LP_DROP_NEW_VARS_IN_BOU = Iparam(119)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_READ_LP_QUOTED_NAMES = Iparam(120)
...
"""
const MSK_IPAR_READ_MPS_FORMAT = Iparam(121)
...
"""
const MSK_IPAR_READ_MPS_WIDTH = Iparam(122)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_READ_TASK_IGNORE_PARAM = Iparam(123)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_REMOVE_UNUSED_SOLUTIONS = Iparam(124)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SENSITIVITY_ALL = Iparam(125)
...
* `MSK_OPTIMIZER_MIXED_INT`. The mixed-integer optimizer.
"""
const MSK_IPAR_SENSITIVITY_OPTIMIZER = Iparam(126)
...
"""
const MSK_IPAR_SENSITIVITY_TYPE = Iparam(127)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SIM_BASIS_FACTOR_USE = Iparam(128)
...
* `MSK_SIM_DEGEN_MINIMUM`. The simplex optimizer should use a minimum degeneration strategy.
"""
const MSK_IPAR_SIM_DEGEN = Iparam(129)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_SIM_DUAL_CRASH = Iparam(130)
...
"""
const MSK_IPAR_SIM_DUAL_PHASEONE_METHOD = Iparam(131)
...
"""
const MSK_IPAR_SIM_DUAL_RESTRICT_SELECTION = Iparam(132)
...
"""
const MSK_IPAR_SIM_DUAL_SELECTION = Iparam(133)
...
* `MSK_SIM_EXPLOIT_DUPVEC_FREE`. The simplex optimizer can choose freely.
"""
const MSK_IPAR_SIM_EXPLOIT_DUPVEC = Iparam(134)
...
* `MSK_SIM_HOTSTART_STATUS_KEYS`. Only the status keys of the constraints and variables are used to choose the type of hot-start.
"""
const MSK_IPAR_SIM_HOTSTART = Iparam(135)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SIM_HOTSTART_LU = Iparam(136)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_SIM_MAX_ITERATIONS = Iparam(137)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_SIM_MAX_NUM_SETBACKS = Iparam(138)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SIM_NON_SINGULAR = Iparam(139)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_SIM_PRIMAL_CRASH = Iparam(140)
...
Possible Values: Any number between 0 and 10.
"""
const MSK_IPAR_SIM_PRIMAL_PHASEONE_METHOD = Iparam(141)
...
Possible Values: Any number between 0 and 100.
"""
const MSK_IPAR_SIM_PRIMAL_RESTRICT_SELECTION = Iparam(142)
...
* `MSK_SIM_SELECTION_PARTIAL`. The optimizer uses a partial selection approach.
"""
const MSK_IPAR_SIM_PRIMAL_SELECTION = Iparam(143)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_SIM_REFACTOR_FREQ = Iparam(144)
...
* `MSK_SIM_REFORMULATION_AGGRESSIVE`. The simplex optimizer should use an aggressive reformulation strategy.
"""
const MSK_IPAR_SIM_REFORMULATION = Iparam(145)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SIM_SAVE_LU = Iparam(146)
...
* `MSK_SCALING_NONE`. No scaling is performed.
"""
const MSK_IPAR_SIM_SCALING = Iparam(147)
...
"""
const MSK_IPAR_SIM_SCALING_METHOD = Iparam(148)
...
"""
const MSK_IPAR_SIM_SEED = Iparam(149)
...
* `MSK_SOLVE_DUAL`. The optimizer should solve the dual problem.
"""
const MSK_IPAR_SIM_SOLVE_FORM = Iparam(150)
...
Possible Values: Any number between 0 and 100.
"""
const MSK_IPAR_SIM_STABILITY_PRIORITY = Iparam(151)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SIM_SWITCH_OPTIMIZER = Iparam(152)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SOL_FILTER_KEEP_BASIC = Iparam(153)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SOL_FILTER_KEEP_RANGED = Iparam(154)
...
Possible Values: Any number between -inf and +inf.
"""
const MSK_IPAR_SOL_READ_NAME_WIDTH = Iparam(155)
...
Possible Values: Any number between 80 and +inf.
"""
const MSK_IPAR_SOL_READ_WIDTH = Iparam(156)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_SOLUTION_CALLBACK = Iparam(157)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_TIMING_LEVEL = Iparam(158)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_BAS_CONSTRAINTS = Iparam(159)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_BAS_HEAD = Iparam(160)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_BAS_VARIABLES = Iparam(161)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_WRITE_COMPRESSION = Iparam(162)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_DATA_PARAM = Iparam(163)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_FREE_CON = Iparam(164)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_GENERIC_NAMES = Iparam(165)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_WRITE_GENERIC_NAMES_IO = Iparam(166)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_IGNORE_INCOMPATIBLE_ITEMS = Iparam(167)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_INT_CONSTRAINTS = Iparam(168)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_INT_HEAD = Iparam(169)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_INT_VARIABLES = Iparam(170)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_JSON_INDENTATION = Iparam(171)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_LP_FULL_OBJ = Iparam(172)
...
"""
const MSK_IPAR_WRITE_LP_LINE_WIDTH = Iparam(173)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_LP_QUOTED_NAMES = Iparam(174)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_LP_STRICT_FORMAT = Iparam(175)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_WRITE_LP_TERMS_PER_LINE = Iparam(176)
...
* `MSK_MPS_FORMAT_CPLEX`. The CPLEX compatible version of the MPS format is employed.
"""
const MSK_IPAR_WRITE_MPS_FORMAT = Iparam(177)
...
* `MSK_OFF`. Switch the option off.
"""
const MSK_IPAR_WRITE_MPS_INT = Iparam(178)
...
Possible Values: Any number between 0 and +inf.
"""
const MSK_IPAR_WRITE_PRECISION = Iparam(179)
...
tostr(v::Iparam) = if v.value == 0 "Mosek.MSK_IPAR_ANA_SOL_BASIS"
  ...
  elseif v.value == 62 "Mosek.MSK_IPAR_MIO_CUT_CLIQUE"
  elseif v.value == 63 "Mosek.MSK_IPAR_MIO_CUT_CMIR"
  elseif v.value == 64 "Mosek.MSK_IPAR_MIO_CUT_GMI"
  elseif v.value == 65 "Mosek.MSK_IPAR_MIO_CUT_IMPLIED_BOUND"
  elseif v.value == 66 "Mosek.MSK_IPAR_MIO_CUT_KNAPSACK_COVER"
  elseif v.value == 67 "Mosek.MSK_IPAR_MIO_CUT_LIPRO"
  elseif v.value == 68 "Mosek.MSK_IPAR_MIO_CUT_SELECTION_LEVEL"
  elseif v.value == 69 "Mosek.MSK_IPAR_MIO_DATA_PERMUTATION_METHOD"
  ...
  elseif v.value == 77 "Mosek.MSK_IPAR_MIO_MODE"
  elseif v.value == 78 "Mosek.MSK_IPAR_MIO_NODE_OPTIMIZER"
  elseif v.value == 79 "Mosek.MSK_IPAR_MIO_NODE_SELECTION"
  elseif v.value == 80 "Mosek.MSK_IPAR_MIO_NUMERICAL_EMPHASIS_LEVEL"
  elseif v.value == 81 "Mosek.MSK_IPAR_MIO_PERSPECTIVE_REFORMULATE"
  elseif v.value == 82 "Mosek.MSK_IPAR_MIO_PRESOLVE_AGGREGATOR_MAX_FILL"
  ...
  elseif v.value == 86 "Mosek.MSK_IPAR_MIO_RINS_MAX_NODES"
  elseif v.value == 87 "Mosek.MSK_IPAR_MIO_ROOT_OPTIMIZER"
  elseif v.value == 88 "Mosek.MSK_IPAR_MIO_ROOT_REPEAT_PRESOLVE_LEVEL"
  elseif v.value == 89 "Mosek.MSK_IPAR_MIO_SEED"
  elseif v.value == 90 "Mosek.MSK_IPAR_MIO_VB_DETECTION_LEVEL"
  elseif v.value == 91 "Mosek.MSK_IPAR_MT_SPINCOUNT"
  elseif v.value == 92 "Mosek.MSK_IPAR_NG"
  elseif v.value == 93 "Mosek.MSK_IPAR_NUM_THREADS"
  elseif v.value == 94 "Mosek.MSK_IPAR_OPF_WRITE_HEADER"
  elseif v.value == 95 "Mosek.MSK_IPAR_OPF_WRITE_HINTS"
  elseif v.value == 96 "Mosek.MSK_IPAR_OPF_WRITE_LINE_LENGTH"
  elseif v.value == 97 "Mosek.MSK_IPAR_OPF_WRITE_PARAMETERS"
  elseif v.value == 98 "Mosek.MSK_IPAR_OPF_WRITE_PROBLEM"
  elseif v.value == 99 "Mosek.MSK_IPAR_OPF_WRITE_SOL_BAS"
  elseif v.value == 100 "Mosek.MSK_IPAR_OPF_WRITE_SOL_ITG"
  elseif v.value == 101 "Mosek.MSK_IPAR_OPF_WRITE_SOL_ITR"
  elseif v.value == 102 "Mosek.MSK_IPAR_OPF_WRITE_SOLUTIONS"
  elseif v.value == 103 "Mosek.MSK_IPAR_OPTIMIZER"
  elseif v.value == 104 "Mosek.MSK_IPAR_PARAM_READ_CASE_NAME"
  elseif v.value == 105 "Mosek.MSK_IPAR_PARAM_READ_IGN_ERROR"
  elseif v.value == 106 "Mosek.MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_FILL"
  elseif v.value == 107 "Mosek.MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_NUM_TRIES"
  elseif v.value == 108 "Mosek.MSK_IPAR_PRESOLVE_LEVEL"
  elseif v.value == 109 "Mosek.MSK_IPAR_PRESOLVE_LINDEP_ABS_WORK_TRH"
  elseif v.value == 110 "Mosek.MSK_IPAR_PRESOLVE_LINDEP_REL_WORK_TRH"
  elseif v.value == 111 "Mosek.MSK_IPAR_PRESOLVE_LINDEP_USE"
  elseif v.value == 112 "Mosek.MSK_IPAR_PRESOLVE_MAX_NUM_PASS"
  elseif v.value == 113 "Mosek.MSK_IPAR_PRESOLVE_MAX_NUM_REDUCTIONS"
  elseif v.value == 114 "Mosek.MSK_IPAR_PRESOLVE_USE"
  elseif v.value == 115 "Mosek.MSK_IPAR_PRIMAL_REPAIR_OPTIMIZER"
  elseif v.value == 116 "Mosek.MSK_IPAR_PTF_WRITE_TRANSFORM"
  elseif v.value == 117 "Mosek.MSK_IPAR_READ_DEBUG"
  elseif v.value == 118 "Mosek.MSK_IPAR_READ_KEEP_FREE_CON"
  elseif v.value == 119 "Mosek.MSK_IPAR_READ_LP_DROP_NEW_VARS_IN_BOU"
  elseif v.value == 120 "Mosek.MSK_IPAR_READ_LP_QUOTED_NAMES"
  elseif v.value == 121 "Mosek.MSK_IPAR_READ_MPS_FORMAT"
  elseif v.value == 122 "Mosek.MSK_IPAR_READ_MPS_WIDTH"
  elseif v.value == 123 "Mosek.MSK_IPAR_READ_TASK_IGNORE_PARAM"
  elseif v.value == 124 "Mosek.MSK_IPAR_REMOVE_UNUSED_SOLUTIONS"
  elseif v.value == 125 "Mosek.MSK_IPAR_SENSITIVITY_ALL"
  elseif v.value == 126 "Mosek.MSK_IPAR_SENSITIVITY_OPTIMIZER"
  elseif v.value == 127 "Mosek.MSK_IPAR_SENSITIVITY_TYPE"
  elseif v.value == 128 "Mosek.MSK_IPAR_SIM_BASIS_FACTOR_USE"
  elseif v.value == 129 "Mosek.MSK_IPAR_SIM_DEGEN"
  elseif v.value == 130 "Mosek.MSK_IPAR_SIM_DUAL_CRASH"
  elseif v.value == 131 "Mosek.MSK_IPAR_SIM_DUAL_PHASEONE_METHOD"
  elseif v.value == 132 "Mosek.MSK_IPAR_SIM_DUAL_RESTRICT_SELECTION"
  elseif v.value == 133 "Mosek.MSK_IPAR_SIM_DUAL_SELECTION"
  elseif v.value == 134 "Mosek.MSK_IPAR_SIM_EXPLOIT_DUPVEC"
  elseif v.value == 135 "Mosek.MSK_IPAR_SIM_HOTSTART"
  elseif v.value == 136 "Mosek.MSK_IPAR_SIM_HOTSTART_LU"
  elseif v.value == 137 "Mosek.MSK_IPAR_SIM_MAX_ITERATIONS"
  elseif v.value == 138 "Mosek.MSK_IPAR_SIM_MAX_NUM_SETBACKS"
  elseif v.value == 139 "Mosek.MSK_IPAR_SIM_NON_SINGULAR"
  elseif v.value == 140 "Mosek.MSK_IPAR_SIM_PRIMAL_CRASH"
  elseif v.value == 141 "Mosek.MSK_IPAR_SIM_PRIMAL_PHASEONE_METHOD"
  elseif v.value == 142 "Mosek.MSK_IPAR_SIM_PRIMAL_RESTRICT_SELECTION"
  elseif v.value == 143 "Mosek.MSK_IPAR_SIM_PRIMAL_SELECTION"
  elseif v.value == 144 "Mosek.MSK_IPAR_SIM_REFACTOR_FREQ"
  elseif v.value == 145 "Mosek.MSK_IPAR_SIM_REFORMULATION"
  elseif v.value == 146 "Mosek.MSK_IPAR_SIM_SAVE_LU"
  elseif v.value == 147 "Mosek.MSK_IPAR_SIM_SCALING"
  elseif v.value == 148 "Mosek.MSK_IPAR_SIM_SCALING_METHOD"
  elseif v.value == 149 "Mosek.MSK_IPAR_SIM_SEED"
  elseif v.value == 150 "Mosek.MSK_IPAR_SIM_SOLVE_FORM"
  elseif v.value == 151 "Mosek.MSK_IPAR_SIM_STABILITY_PRIORITY"
  elseif v.value == 152 "Mosek.MSK_IPAR_SIM_SWITCH_OPTIMIZER"
  elseif v.value == 153 "Mosek.MSK_IPAR_SOL_FILTER_KEEP_BASIC"
  elseif v.value == 154 "Mosek.MSK_IPAR_SOL_FILTER_KEEP_RANGED"
  elseif v.value == 155 "Mosek.MSK_IPAR_SOL_READ_NAME_WIDTH"
  elseif v.value == 156 "Mosek.MSK_IPAR_SOL_READ_WIDTH"
  elseif v.value == 157 "Mosek.MSK_IPAR_SOLUTION_CALLBACK"
  elseif v.value == 158 "Mosek.MSK_IPAR_TIMING_LEVEL"
  elseif v.value == 159 "Mosek.MSK_IPAR_WRITE_BAS_CONSTRAINTS"
  elseif v.value == 160 "Mosek.MSK_IPAR_WRITE_BAS_HEAD"
  elseif v.value == 161 "Mosek.MSK_IPAR_WRITE_BAS_VARIABLES"
  elseif v.value == 162 "Mosek.MSK_IPAR_WRITE_COMPRESSION"
  elseif v.value == 163 "Mosek.MSK_IPAR_WRITE_DATA_PARAM"
  elseif v.value == 164 "Mosek.MSK_IPAR_WRITE_FREE_CON"
  elseif v.value == 165 "Mosek.MSK_IPAR_WRITE_GENERIC_NAMES"
  elseif v.value == 166 "Mosek.MSK_IPAR_WRITE_GENERIC_NAMES_IO"
  elseif v.value == 167 "Mosek.MSK_IPAR_WRITE_IGNORE_INCOMPATIBLE_ITEMS"
  elseif v.value == 168 "Mosek.MSK_IPAR_WRITE_INT_CONSTRAINTS"
  elseif v.value == 169 "Mosek.MSK_IPAR_WRITE_INT_HEAD"
  elseif v.value == 170 "Mosek.MSK_IPAR_WRITE_INT_VARIABLES"
  elseif v.value == 171 "Mosek.MSK_IPAR_WRITE_JSON_INDENTATION"
  elseif v.value == 172 "Mosek.MSK_IPAR_WRITE_LP_FULL_OBJ"
  elseif v.value == 173 "Mosek.MSK_IPAR_WRITE_LP_LINE_WIDTH"
  elseif v.value == 174 "Mosek.MSK_IPAR_WRITE_LP_QUOTED_NAMES"
  elseif v.value == 175 "Mosek.MSK_IPAR_WRITE_LP_STRICT_FORMAT"
  elseif v.value == 176 "Mosek.MSK_IPAR_WRITE_LP_TERMS_PER_LINE"
  elseif v.value == 177 "Mosek.MSK_IPAR_WRITE_MPS_FORMAT"
  elseif v.value == 178 "Mosek.MSK_IPAR_WRITE_MPS_INT"
  elseif v.value == 179 "Mosek.MSK_IPAR_WRITE_PRECISION"
