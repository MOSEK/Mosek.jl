...
* ``task:: MSKtask`` An optimization task.
* ``ct:: Int32`` (`Enum conetype`_) Specifies the type of the cone.
...
* ``task:: MSKtask`` An optimization task.
* ``ct:: Array{Int32}`` (`Enum conetype`_) Specifies the type of the cone.
...
* ``callbackcodestr:: AbstractString`` String corresponding to the call-back code.
...
::
    ...
    function getdualsolutionnorms
    ( task::     MSKtask,
      whichsol:: Int32 )
    -> nrmy,nrmslc,nrmsuc,nrmslx,nrmsux,nrmsnx,nrmbars
...
::
    ...
    ( task::        MSKtask,
      infitemname:: AbstractString )
    -> ivalue


* ``task:: MSKtask`` An optimization task.
* ``infitemname:: String`` The name of the integer information.
* ``ivalue:: Int32`` The value of the required integer information item.
...
::
    ...
    function getprimalsolutionnorms
    ( task::     MSKtask,
      whichsol:: Int32 )
    -> nrmxc,nrmxx,nrmbarx
...
* ``task:: MSKtask`` An optimization task.
* ``whichsol:: Int32`` (`Enum soltype`_) Selects a solution.
* ``nrmxc:: Float64`` The norm of xc vector.
* ``nrmxx:: Float64`` The norm of xx vector.
* ``nrmbarx:: Float64`` The norm of barx vector.
...
* ``task:: MSKtask`` An optimization task.
* ``taskname:: AbstractString`` Is assigned the task name.
